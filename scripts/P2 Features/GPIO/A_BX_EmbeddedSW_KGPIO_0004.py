...
# A_BX_EmbeddedSW_KGPIO_0004      Check if GPIO level can be changed as the external input level if it is configured as Input and internal pull up resistor
#
# Requirement
#   1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KGPIO_0004
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_KGPIO_0004"
...
try:
    ...
    for io in gpio:
        print '\nOn DUT'
        print "Step 1: Set GPIO %s as input with pull up resistor" % io
