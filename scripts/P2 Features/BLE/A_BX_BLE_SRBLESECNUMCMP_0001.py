...
# A_BX_BLE_SRBLESECNUMCMP_0001                  Check passkey entry secure bonding
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_BLE_SRBLESECNUMCMP_0001
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BLE_SRBLESECNUMCMP_0001"
...
try:
    ...
    print "\nStep 11: DUT: Confirm that the two numbers displayed on the initiator and responder are the same\n"
    SagSendAT(uart_com, 'AT+SRBLESECNUMCMP=1,1\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 3000)
    
    print "\nStep 12: AUX: SConfirm that the two numbers displayed on the initiator and responder are the same\n"
    SagSendAT(aux1_com, 'AT+SRBLESECNUMCMP=1,1\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 3000)
    SagWaitnMatchResp(uart_com, ['\r\n+SRBLESECBOND: 1,1\r\n'], 3000)
    SagWaitnMatchResp(aux1_com, ['\r\n+SRBLESECBOND: 1,1\r\n'], 3000)

    print "\nStep 13: DUT: Clear bonded devices information\n"
    SagSendAT(uart_com, 'AT+SRBLESECCLEAR\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+SRBLE_IND: 1,0,22\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['\r\n+SRBLE_IND: 1,0,19\r\n'], 2000)
 
    print "\nStep 14: AUX1: Stop advertising\n"
    SagSendAT(aux1_com, 'AT+SRBLEADV=0\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    
    print "\nStep 15: Delete the BLE configure\n"
