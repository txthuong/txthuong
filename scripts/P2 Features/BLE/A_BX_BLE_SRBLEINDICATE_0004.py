...
# A_BX_BLE_SRBLEINDICATE_0004                   Check maximum data module can send by command +SRBLEINDICATE
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_BLE_SRBLEINDICATE_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BLE_SRBLEINDICATE_0003"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check maximum data module can send by command +SRBLEINDICATE" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 7: Perform +SRBLEINDICATE with data has length equal to MTU\n"
    data='01234567890123456789012'
    print "Length of the string: ", len(data)
    SagSendAT(uart_com, 'AT+SRBLEINDICATE=1,52,"%s"\r' %data)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print "\nStep 8: Perform +SRBLEINDICATE with data has length equal to MTU+1\n"
    data='012345678901234567890123'
    print "Length of the string: ", len(data)
    SagSendAT(uart_com, 'AT+SRBLEINDICATE=1,52,"%s"\r' %data)
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    
    print "\nStep 9: Perform +SRBLEINDICATE with data has length equal to MTU again\n"
    data='01234567890123456789012'
    print "Length of the string: ", len(data)
    SagSendAT(uart_com, 'AT+SRBLEINDICATE=1,52,"%s"\r' %data)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
