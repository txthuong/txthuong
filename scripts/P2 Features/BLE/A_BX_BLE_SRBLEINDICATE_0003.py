...
# A_BX_BLE_SRBLEINDICATE_0003                   Check +SRBLEINDICATE with not existing characteristic
# 
# Requirement
# 2 Euler modules
#    
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check +SRBLEINDICATE with not existing characteristic" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 5: Perform +SRBLEINDICATE with not existing characteristic\n"
    SagSendAT(uart_com, 'AT+SRBLEINDICATE=1,52,"\\00\\01\\02\\03"\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    
    print "\nStep 6: On DUT: Add a primary service\n"
    SagSendAT(uart_com, 'AT+SRBLEADDSERV=1234\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRBLEADDSERV: 50\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    
    print "\nStep 7: Add a characteristic to the service\n"
    SagSendAT(uart_com, 'AT+SRBLEADDCHAR=50, "111A", 10, 11\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRBLEADDCHAR: 52\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    
    print "\nStep 8: Perform +SRBLEINDICATE\n"
    SagSendAT(uart_com, 'AT+SRBLEINDICATE=1,52,"\\00\\01\\02\\03"\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    ...
    print "\nStep 10: Perform +SRBLEINDICATE again\n"
    SagSendAT(uart_com, 'AT+SRBLEINDICATE=1,52,"\\00\\01\\02\\03"\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
