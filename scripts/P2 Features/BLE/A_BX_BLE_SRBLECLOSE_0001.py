...
# A_BX_BLE_SRBLECLOSE_0001                      Check syntax of +SRBLECLOSE command with valid values, invalid values and values out of range
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_BLE_SRBLECLOSE_0001
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BLE_SRBLECLOSE_0001"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check syntax of +SRBLECLOSE command with valid values, invalid values and values out of range" % test_ID
    print "*****************************************************************************************************************"
    
    print "\nStep 1: Check +SRBLECLOSE test command\n"
    SagSendAT(uart_com, 'AT+SRBLECLOSE=?\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    
    print "\nStep 2: Checking +SRBLECLOSE read command\n"
    SagSendAT(uart_com, 'AT+SRBLECLOSE?\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    
    print "\nStep 3: Checking +SRBLECLOSE execute command\n"
    SagSendAT(uart_com, 'AT+SRBLECLOSE\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    
    print "\nStep 4: Checking +SRBLECLOSE write command (No BLE session exist)\n"
    ...
    print "\nStep 10: Checking SRBLECLOSE write command with missing parameter\n"
    SagSendAT(uart_com, 'AT+SRBLECLOSE=\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 917\r\n'], 2000)
    
    print "\nStep 11: Checking SRBLECLOSE write command with extra parameter\n"
    SagSendAT(uart_com, 'AT+SRBLECLOSE=1,1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 915\r\n'], 2000)
    
    print "\nStep 12: Checking SRBLECLOSE write command with extra parameter\n"
    SagSendAT(uart_com, 'AT+SRBLECLOSE=1,1,a\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 915\r\n'], 2000)

    print "\nStep 13: Checking SRBLECLOSE write command with invalid parameter\n"
    for i in('a','*','%', '#'):
        SagSendAT(uart_com, 'AT+SRBLECLOSE=%s\r' %i)
        SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 916\r\n'], 2000)
    SagSendAT(uart_com, 'AT+SRBLECLOSE=2\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 910\r\n'], 2000)
    
    print "\nStep 14: Checking +SRBLECLOSE write command (Close the connection)\n"
    SagSendAT(uart_com, 'AT+SRBLECLOSE=1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRBLE_IND: 1,0,22\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['\r\n+SRBLE_IND: 1,0,19\r\n'], 2000)
    
    print "\nStep 15: Close the BLE configure\n"
