...
# A_BX_BLE_SRBLESECCLEAR_0001                   Check syntax of +SRBLESECCLEAR command with valid values
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_BLE_SRBLESECCLEAR_0001
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BLE_SRBLESECCLEAR_0001"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check syntax of +SRBLESECCLEAR command with valid values" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 11: Checking SRBLESECCLEAR test command\n"
    SagSendAT(uart_com, 'AT+SRBLESECCLEAR=?\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    
    print "\nStep 12: Checking SRBLESECCLEAR read command\n"
    SagSendAT(uart_com, 'AT+SRBLESECCLEAR?\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    
    print "\nStep 13: Checking SRBLESECCLEAR write command\n"
    SagSendAT(uart_com, 'AT+SRBLESECCLEAR=%s\r' %aux1_bluetooth_addr)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+SRBLE_IND: 1,0,22\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['\r\n+SRBLE_IND: 1,0,19\r\n'], 2000)
    
    print "\nStep 14: Checking SRBLESECCLEAR execute command\n"
    SagSendAT(uart_com, 'AT+SRBLESECCLEAR\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
 
    print "\nStep 15: AUX1: Stop advertising\n"
