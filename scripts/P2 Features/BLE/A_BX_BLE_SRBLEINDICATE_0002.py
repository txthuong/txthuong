...
# A_BX_BLE_SRBLEINDICATE_0002                   Check +SRBLEINDICATE with not existing and not connected session
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_BLE_SRBLEINDICATE_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BLE_SRBLEINDICATE_0002"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check +SRBLEINDICATE with not existing and not connected session" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 4: Perform +SRBLEINDICATE with not configured session\n"
    ...
    print "\nStep 6: Perform +SRBLEINDICATE without active BLE session\n"
    SagSendAT(uart_com, 'AT+SRBLEINDICATE=1,52,"\\00\\01\\02\\03"\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    ...
    print "\nStep 9: Perform +SRBLEINDICATE\n"
    SagSendAT(uart_com, 'AT+SRBLEINDICATE=1,52,"\\00\\01\\02\\03"\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print "\nStep 10: DUT: Clear bonded devices information\n"
    SagSendAT(aux1_com, 'AT+SRBLESECCLEAR=%s\r' %dut_bluetooth_addr)
    SagWaitnMatchResp(aux1_com, ['\r\n+SRBLE_IND: 1,0,22\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['\r\n+SRBLE_ERROR: 1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+SRBLE_IND: 1,0,19\r\n'], 2000)
 
    print "\nStep 11: AUX1: Stop advertising\n"
