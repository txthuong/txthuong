...
# A_BX_POWER_SRPSCFG_0003                  Check if module can wake up from light sleep with wake-up mode RTC GPIO and input level which will trigger wake-up to HIGH
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_POWER_SRPSCFG_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_POWER_SRPSCFG_0003"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s: Check if module can wake up from light sleep with wake-up mode RTC GPIO and input level which will trigger wake-up to HIGH" % test_ID
    print "***************************************************************************************************************"
    ...
    for gpio in gpio_list:
        ...
        print "\nStep 6: Set GPIO %s to HIGH to Wake up module from light sleep mode" % gpio
