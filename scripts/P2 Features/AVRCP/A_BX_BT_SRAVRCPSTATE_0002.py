...
# A_BX_BT_SRAVRCPSTATE_0002                     Check syntax for +SRAVRCPSTATE command
# Requirement
# 1 Euler module
#    
# Author: ptnlam
...
# -----------------------------------------------------------------------------------
# A_BX_BT_SRAVRCPSTATE_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BT_SRAVRCPSTATE_0002"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check that +SRAVRCPSTATE command takes effect" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 4: Check default AVRCP state\n"
    SagSendAT(uart_com, 'AT+SRAVRCPSTATE?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRAVRCPSTATE: 1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    
    print "\nStep 5: Disable AVRCP\n"
    SagSendAT(uart_com, 'AT+SRAVRCPSTATE=0\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print "\nStep 6: Check default AVRCP state\n"
    SagSendAT(uart_com, 'AT+SRAVRCPSTATE?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRAVRCPSTATE: 0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
