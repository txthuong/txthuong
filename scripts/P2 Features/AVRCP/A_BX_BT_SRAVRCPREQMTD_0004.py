...
# A_BX_BT_SRAVRCPREQMTD_0004                    Check module can't perform +SRAVRCPREQMTD with multiple devices
# Requirement
# 1 Euler module
#    
# Author: ptnlam
...
# -----------------------------------------------------------------------------------
# A_BX_BT_SRAVRCPREQMTD_0004
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BT_SRAVRCPREQMTD_0004"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check module can't perform +SRAVRCPREQMTD with multiple devices" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 10: Check +SRAVRCPREQMTD write command with not connect session\n"
    for metadata in (0,1,2,3,4,5,6):
        SagSendAT(uart_com, 'AT+SRAVRCPREQMTD=2,%s\r'%metadata)
        SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 922\r\n'], 2000)
