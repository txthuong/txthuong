...
# A_BX_BT_SRAVRCPSTATE_0003                     Check +SRAVRCPSTATE when AVRCP profile is already disable or enable
# Requirement
# 1 Euler module
#    
# Author: ptnlam
...
# -----------------------------------------------------------------------------------
# A_BX_BT_SRAVRCPSTATE_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BT_SRAVRCPSTATE_0003"
...
try:
    ...
    print "\nStep 5: Check default AVRCP state\n"
    SagSendAT(uart_com, 'AT+SRAVRCPSTATE?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRAVRCPSTATE: 1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
