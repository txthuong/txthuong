...
# A_BX_BT_SRAVRCPREQMTD_0003                    Check all supported <metadata_id> and <info> responses
# Requirement
# 1 Euler module
#    
# Author: ptnlam
...
# -----------------------------------------------------------------------------------
# A_BX_BT_SRAVRCPREQMTD_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BT_SRAVRCPREQMTD_0003"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check all supported <metadata_id> and <info> responses" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 6: Configure a AVRCP session with bt_addr\n"
    ...
    print "\nStep 8: Query AVRCP session (No configuration exist)\n"
    SagSendAT(uart_com, 'AT+SRAVRCPCFG?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRBTCFG: 1,0,"%s",AVRCP\r\n' %bt_addr], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    
    print "\nStep 9: Active A2DP session (AVRCP also active)\n"
    ...
    print "\nStep 10: Connect to device, query AVRCP session\n"
    SagSendAT(uart_com, 'AT+SRAVRCPCFG?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRBTCFG: 1,1,"%s",AVRCP\r\n' %bt_addr], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    
    print "\nStep 11: Request metadata information to the remote device\n"
