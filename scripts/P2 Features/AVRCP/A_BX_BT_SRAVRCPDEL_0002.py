...
# A_BX_BT_SRAVRCPDEL_0002                       Check +SRAVRCPDEL incase the session is configured but not connected
# Requirement
# 1 Euler module
#    
# Author: ptnlam
...
# -----------------------------------------------------------------------------------
# A_BX_BT_SRAVRCPDEL_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BT_SRAVRCPDEL_0002"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check +SRAVRCPDEL in case the session is configured but not connected" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 6: Check +SRAVRCPDEL with not configured AVRCP session\n"
    ...
    print "\nStep 11: Check +SRAVRCPDEL with connected session\n"
    SagSendAT(uart_com, 'AT+SRAVRCPDEL=1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 911\r\n'], 2000)
    ...
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['+SRBTCFG: 1,0,"%s",AVRCP\r\n' %bt_addr], 2000)
