...
# A_BX_BT_SRA2DPSTATE_0003                      Check +SRA2DPSTATE with A2DP profile is already disabled or enabled
# 
# Requirement
# 1 module
# Author: ptnlam
...
# -----------------------------------------------------------------------------------
# A_BX_BT_SRA2DPSTATE_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BT_SRA2DPSTATE_0003"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check +SRA2DPSTATE with A2DP profile is already disabled or enabled" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 3: Check default A2DP state\n"
    ...
    print "\nStep 6: Check default A2DP state\n"
    SagSendAT(uart_com, 'AT+SRA2DPSTATE?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRA2DPSTATE: 1, 1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
