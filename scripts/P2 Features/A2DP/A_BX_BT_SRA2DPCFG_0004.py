...
# A_BX_BT_SRA2DPCFG_0004                        Check +SRA2DPCFG with duplicated <bt_addr>
# 
# Requirement
# 1 Euler module
#    
...
# -----------------------------------------------------------------------------------
# A_BX_BT_SRA2DPCFG_0004
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BT_SRA2DPCFG_0004"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check +SRA2DPCFG with duplicated <bt_addr>" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 7: Configure an A2DP session with same <bt_addr>\n"
    SagSendAT(uart_com, 'AT+SRA2DPCFG=FF:FF:FF:FF:FF:00\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 933\r\n'], 2000)
    
    print "\nStep 8: Configure an A2DP session with same <bt_addr>\n"
    SagSendAT(uart_com, 'AT+SRA2DPCFG=FF:FF:FF:FF:FF:11\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRBTCFG: 2,0,"ff:ff:ff:ff:ff:11",A2DP\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print "\nStep 9: Configure an A2DP session with same <bt_addr>\n"
    SagSendAT(uart_com, 'AT+SRA2DPCFG=FF:FF:FF:FF:FF:11\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 933\r\n'], 2000)
