...
# A_BX_BT_SRA2DPCFG_0002                        To check maximum <session_id> is 64 for A2DP profile
# 
# Requirement
# 1 Euler module
#    
...
# -----------------------------------------------------------------------------------
# A_BX_BT_SRA2DPCFG_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BT_SRA2DPCFG_0002"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: To check maximum <session_id> is 64 for A2DP profile" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 5: Configure A2DP profile, repeat 64 times\n"
    ...
    SagSendAT(uart_com, 'AT+SRA2DPCFG=ff:ff:ff:ff:ff:65\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 912\r\n'], 2000)

    print "\nStep 7: Checking +SRA2DPCFG\n"
    SagSendAT(uart_com, 'AT+SRA2DPCFG?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRBTCFG: 1,0,"ff:ff:ff:ff:ff:01",A2DP\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['*+SRBTCFG: 64,0,"ff:ff:ff:ff:ff:64",A2DP\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
   
    print "\nStep 8: Delete A2DP session\n"
    for i in range (1,65):
