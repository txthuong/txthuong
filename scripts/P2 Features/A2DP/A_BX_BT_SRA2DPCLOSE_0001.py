...
# A_BX_BT_SRA2DPCLOSE_0001                      Check syntax of command AT+SRA2DPCLOSE
# 
# Requirement
# 1 Euler module
#    
...
# -----------------------------------------------------------------------------------
# A_BX_BT_SRA2DPCLOSE_0001
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BT_SRA2DPCLOSE_0001"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check syntax of command AT+SRA2DPCLOSE" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 6: Check +SRA2DPCLOSE test command\n"
    SagSendAT(uart_com, 'AT+SRA2DPCLOSE=?\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    
    print "\nStep 7: Check +SRA2DPCLOSE execute command\n"
    SagSendAT(uart_com, 'AT+SRA2DPCLOSE\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    
    print "\nStep 8: Check +SRA2DPCLOSE read command\n"
    SagSendAT(uart_com, 'AT+SRA2DPCLOSE?\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    
    print "\nStep 9: Check +SRA2DPCLOSE write command with not-configured and out-range session\n"
    for i in ('0','2','65'):
        SagSendAT(uart_com, 'AT+SRA2DPCLOSE=%s\r' %i)
        SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 910\r\n'], 2000)
    
    print "\nStep 10: Check +SRA2DPCLOSE write command with invalid parameter\n"
    for i in ('-1','*','a'):
        SagSendAT(uart_com, 'AT+SRA2DPCLOSE=%s\r' %i)
        SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 916\r\n'], 2000)
    
    print "\nStep 11: Check +SRA2DPCLOSE write command with missing parameter\n"
    SagSendAT(uart_com, 'AT+SRA2DPCLOSE=\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 917\r\n'], 2000)
    
    print "\nStep 12: Check +SRA2DPCLOSE write command with extra parameter\n"
    SagSendAT(uart_com, 'AT+SRA2DPCLOSE=1,1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 915\r\n'], 2000)
    
    print "\nStep 13: Check +SRA2DPCLOSE write command with valid parameter\n"
