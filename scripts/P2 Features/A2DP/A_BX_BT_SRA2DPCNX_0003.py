...
# A_BX_BT_SRA2DPCNX_0003                        Check +SRA2DPCNX with session is already actived
# 
# Requirement
...
# -----------------------------------------------------------------------------------
# A_BX_BT_SRA2DPCNX_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_BT_SRA2DPCNX_0003"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check +SRA2DPCNX with session is already actived" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 8: Start A2DP session to remote device again\n"
    SagSendAT(uart_com, 'AT+SRA2DPCNX=1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 911\r\n'], 2000)

    print "\nStep 9: Close A2DP session\n"
