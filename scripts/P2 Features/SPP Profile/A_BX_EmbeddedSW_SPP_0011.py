...
# A_BX_EmbeddedSW_SPP_0011                      Check the module can establish SPP connection to Samsung android smartphone
# 
# Requirement
# 1 module, Samsung smartphone that is installed MelodyClassic
#    
# Author: ptnlam
#
# Jira ticket:
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SPP_0011
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SPP_0011"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check the module can establish SPP connection to Samsung android smartphone" % test_ID
    print "*****************************************************************************************************************"
