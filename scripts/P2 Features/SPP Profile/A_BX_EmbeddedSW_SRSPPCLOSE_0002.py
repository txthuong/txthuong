...
# A_BX_EmbeddedSW_SRSPPCLOSE_0002               Check that module returns to command mode if SPP connection is closed during data mode
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SRSPPCLOSE_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SRSPPCLOSE_0002"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check that module returns to command mode if SPP connection is closed during data mode" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 8: AUX1: Close SPP session to DUT\n"
    SagSendAT(aux1_com, 'AT+SRSPPCLOSE=1\r')
    SagWaitnMatchResp(aux1_com, ['\r\n+SRSPPCLOSE: 1,0\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['OK\r\n'], 2000)
    
    print "\nStep 9: DUT: Check URC: An indicator appears to notify SPP connection has been closed\n"
    SagWaitnMatchResp(uart_com, ['\r\nNO CARRIER\r\n'], 5000)
    SagWaitnMatchResp(uart_com, ['\r\n+SRSPPCLOSE: 1,0\r\n'], 5000)

    print "\nStep 10: Delete SPP session to DUT\n"
