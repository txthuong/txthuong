...
# A_BX_EmbeddedSW_SRSPPSND_0001            Check +SRSPPSND with not actived session
#
# Requirement
#   2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SRSPPSND_0001
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SRSPPSND_0001"
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: Check +SRSPPSND with not actived session" % test_ID
    print "***********************************************************************************************************************"
    ...
    print '\nStep 6: On DUT: Execute +SRSPPSND to send data to AUX1'
    SagSendAT(uart_com, "AT+SRSPPSND=1, Hello AUX1\r")
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    SagWaitnMatchResp(aux1_com, ['+SRSPP_DATA: 1,9,HelloAUX1\r\n'], 2000)
