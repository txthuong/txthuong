...
# A_BX_EmbeddedSW_SPP_0020                      Verify paired information is persistent after module resets
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SPP_0020
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SPP_0020"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Verify paired information is persistent after module resets" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 5: DUT: Activate SPP connection\n"
    ...
    print "\nStep 8: DUT: Query paired information\n"
    SagSendAT(uart_com, 'AT+SRBTPAIR?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRBTPAIR: "%s"\r\n' %aux1_bluetooth_address], 5000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 5000)
    
    print "\nStep 9: AUX: Close SPP connection\n"
    SagSendAT(aux1_com, 'AT+SRSPPCLOSE=1\r')
    SagWaitnMatchResp(aux1_com, ['\r\n+SRSPPCLOSE: 1,0\r\n'], 5000)
    SagWaitnMatchResp(aux1_com, ['OK\r\n'], 5000)

    print "\nStep 10: AUX: Delete SPP connection\n"
