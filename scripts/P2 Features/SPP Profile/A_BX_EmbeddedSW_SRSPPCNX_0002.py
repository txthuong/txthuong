...
# A_BX_EmbeddedSW_SRSPPCNX_0002                 Check +SRSPPCNX with already actived session
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SRSPPCNX_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SRSPPCNX_0002"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check +SRSPPCNX with already actived session" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 8: DUT: Try to active the SPP session again\n"
    SagSendAT(uart_com, 'AT+SRSPPCNX=1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 911\r\n'], 5000)
    
    print "\nStep 9: DUT: Close SPP connection\n"
    SagSendAT(uart_com, 'AT+SRSPPCLOSE=1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRSPPCLOSE: 1,0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    
    print "\nStep 10: AUX1: Check URC: An indicator appears to notify SPP connection has been closed\n"
    SagWaitnMatchResp(aux1_com, ['\r\n+SRSPPCLOSE: 1,0\r\n'], 5000)
    
    print "\nStep 11: DUT: Try to active the SPP session again\n"
    SagSendAT(uart_com, 'AT+SRSPPCNX=1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRSPPCNX: 1,1,*\r\n'], 5000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 5000)
    
    print "\nStep 12: AUX: Check URC\n"
    SagWaitnMatchResp(aux1_com, ['\r\n+SRSPPCNX: 1,1,*\r\n'], 5000)
    
    print "\nStep 13: AUX1: Close SPP connection\n"
    SagSendAT(aux1_com, 'AT+SRSPPCLOSE=1\r')
    SagWaitnMatchResp(aux1_com, ['\r\n+SRSPPCLOSE: 1,0\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['OK\r\n'], 2000)
    
    print "\nStep 14: DUT: Check URC: An indicator appears to notify SPP connection has been closed\n"
    SagWaitnMatchResp(uart_com, ['\r\n+SRSPPCLOSE: 1,0\r\n'], 5000)
    
    print "\nStep 15: DUT: Try to active the SPP session again\n"
    SagSendAT(uart_com, 'AT+SRSPPCNX=1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRSPPCNX: 1,1,*\r\n'], 5000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 5000)
    
    print "\nStep 16: AUX1: Check URC\n"
    SagWaitnMatchResp(aux1_com, ['\r\n+SRSPPCNX: 1,1,*\r\n'], 5000)
    
    print "\nStep 17: AUX1: Close SPP connection\n"
    SagSendAT(aux1_com, 'AT+SRSPPCLOSE=1\r')
    SagWaitnMatchResp(aux1_com, ['\r\n+SRSPPCLOSE: 1,0\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['OK\r\n'], 2000)
    
    print "\nStep 18: DUT: Check URC: An indicator appears to notify SPP connection has been closed\n"
    SagWaitnMatchResp(uart_com, ['\r\n+SRSPPCLOSE: 1,0\r\n'], 5000)
    
    print "\nStep 19: Delete the SPP session\n"
