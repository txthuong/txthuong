...
# A_BX_EmbeddedSW_SPP_0017                      Verify behavior of module when it connects to non discoverable device
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SPP_0017
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SPP_0017"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Verify behavior of module when it connects to non discoverable device" % test_ID
    print "*****************************************************************************************************************"
    ...
    SagSendAT(aux1_com, 'AT+SRBTSTATE=1,0\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    ...
    print "\nStep 6: DUT: Close SPP connection\n"
    ...
    print "\nStep 7: DUT: Clear paired information\n"
    SagSendAT(uart_com, 'AT+SRBTUNPAIR=%s\r' %aux1_bluetooth_address)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 3000)
    
    print "\nStep 8: AUX: Clear paired information\n"
    SagSendAT(aux1_com, 'AT+SRBTUNPAIR=%s\r' %dut_bluetooth_address)
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 3000)
    
    print "\nStep 9: AUX: Change Bluetooth state\n"
    SagSendAT(aux1_com, 'AT+SRBTSTATE=1,2\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    
    print "\nStep 10: DUT: Activate SPP connection\n"
    SagSendAT(uart_com, 'AT+SRSPPCNX=1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRBTPAIR: "%s",1\r\n' %aux1_bluetooth_address], 5000)
    SagWaitnMatchResp(uart_com, ['\r\n+SRSPPCNX: 1,1,*\r\n'], 5000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 5000)
    ...
    print "\nStep 11: DUT: Close SPP connection\n"
    SagSendAT(uart_com, 'AT+SRSPPCLOSE=1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRSPPCLOSE: 1,0\r\n'], 5000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 5000)
    ...
    print "\nStep 12: DUT, AUX: Delete SPP connection\n"
