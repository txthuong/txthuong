...
# A_BX_EmbeddedSW_SPP_0002                      Check Syntax of write +SRSPPSTART command with valid values, invalid values and values out of range
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SPP_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SPP_0002"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check Syntax of write +SRSPPSTART command with valid values, invalid values and values out of range" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 6: DUT: Start SPP data mode with invalid <session_id>\n"
    SagSendAT(uart_com, 'AT+SRSPPSTART=3\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 910\r\n'], 2000)
    
    print "\nStep 7: DUT: Start SPP data mode with invalid <session_id>\n"
    SagSendAT(uart_com, 'AT+SRSPPSTART=@2\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 916\r\n'], 2000)
    
    print "\nStep 8: DUT: Start SPP data mode with out of range <session_id>\n"
    SagSendAT(uart_com, 'AT+SRSPPSTART=-1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 910\r\n'], 2000)
   
    print "\nStep 9: DUT: Start SPP data mode with valid <session_id>\n"
    SagSendAT(uart_com, 'AT+SRSPPSTART=1\r')
    SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 2000)
    SagSendAT(uart_com, 'a')
    SagSendAT(uart_com, '+++')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    SagWaitnMatchResp(aux1_com, ['+SRSPP_DATA: 1,1,a\r\n'], 2000)
    ...
    print "\nStep 11: DUT: Delete SPP connection\n"
