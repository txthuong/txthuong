...
# A_BX_EmbeddedSW_SPP_0016                      Verify behavior of module when it connects to un-connectable device
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SPP_0016
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SPP_0016"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Verify behavior of module when it connects to un-connectable device" % test_ID
    print "*****************************************************************************************************************"
    ...
    SagSendAT(aux1_com, 'AT+SRBTSTATE=0,2\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    ...
    print "\nStep 6: AUX: Change Bluetooth state of module\n"
    ...
    print "\nStep 9: DUT, AUX: Delete SPP connection\n"
