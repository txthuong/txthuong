...
# A_BX_EmbeddedSW_SPP_0018                      Verify behavior of module when it connects to un-pairable device
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SPP_0018
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SPP_0018"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Verify behavior of module when it connects to un-pairable device" % test_ID
    print "*****************************************************************************************************************"
    ...
    SagSendAT(aux1_com, 'AT+SRBTSTATE=1,2,0\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    ...
    print "\nStep 6: AUX: Change Bluetooth state\n"
    SagSendAT(aux1_com, 'AT+SRBTSTATE=1,2,1\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    
    print "\nStep 7: DUT: Activate SPP connection\n"
    SagSendAT(uart_com, 'AT+SRSPPCNX=1\r')
