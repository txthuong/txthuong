...
# A_BX_EmbeddedSW_SPP_0014                      Check the module can establish SPP connection to Google android smartphone
# 
# Requirement
# 1 module, Google smartphone that is installed MelodyClassic
#    
# Author: ptnlam
#
# Jira ticket:
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SPP_0014
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SPP_0014"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check the module can establish SPP connection to Google android smartphone" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 6: DUT: Activate SPP connection to smart phone \n"
