...
# A_BX_EmbeddedSW_SRSPP_DATA_0003          Check +SRSPP_DATA with various data is sent out by AT+SRSPPSTART in stress test
#
# Requirement
#   2 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SRSPP_DATA_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SRSPP_DATA_0003"
...
try:
    ...
    print '\nStep 6: Execute +SRSPPSTART to send data to AUX1'
    ...
    if SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 5000):
        ...
        print '----> Problem: Module does not go to data mode properly !!!'
