...
# A_BX_EmbeddedSW_SPP_0005                      Check Syntax of write +SRSPPDEL command with valid values, invalid values and values out of range
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SPP_0005
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SPP_0005"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check Syntax of write +SRSPPDEL command with valid values, invalid values and values out of range" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 6: DUT: Close SPP connection with out of range value\n"
    ...
    print "\nStep 8:DUT: Delete SPP connection with invalid value\n"
    SagSendAT(uart_com, 'AT+SRSPPDEL=2\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 910\r\n'], 2000)
    
    print "\nStep 9: DUT: Delete SPP connection with invalid value\n"
    SagSendAT(uart_com, 'AT+SRSPPDEL=@1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 916\r\n'], 2000)
    
    print "\nStep 10:DUT: Send data to AUX with out of range value\n"
    SagSendAT(uart_com, 'AT+SRSPPDEL=-1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 910\r\n'], 2000)
   
    print "\nStep 11: DUT: Delete SPP connection with valid value\n"
    SagSendAT(uart_com, 'AT+SRSPPDEL=1\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print "\nStep 12: DUT: Query current SPP connection\n"
    SagSendAT(uart_com, 'AT+SRSPPCFG?\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print "\nStep 14: AUX: Delete SPP connection\n"
