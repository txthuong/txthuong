...
# A_BX_EmbeddedSW_SRSPPCLOSE_0003               Check +SRSPPCLOSE with not actived session
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SRSPPCLOSE_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SRSPPCLOSE_0003"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check +SRSPPCLOSE with not actived session" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 9: DUT: Try to close the SPP session one more time\n"
    SagSendAT(uart_com, 'AT+SRSPPCLOSE=1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 922\r\n'], 2000)
    
    print "\nStep 10: AUX1: Try to close the SPP session\n"
