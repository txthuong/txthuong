...
# A_BX_EmbeddedSW_SRSPPSTART_0001          Check +SRSPPSTART with not actived session
# Requirement
#   2 Euler modules
#
# Author: txthuong
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SRSPPSTART_0001
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SRSPPSTART_0001"
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: Check +SRSPPSTART with not actived session" % test_ID
    print "***********************************************************************************************************************"
    ...
    print '\nStep 5: On DUT: Execute +SRSPPSTART without active SPP session'
    SagSendAT(uart_com, 'AT+SRSPPSTART=1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 922\r\n'], 2000)
    
    print '\nStep 6: Active the SPP session to AUX1'
    ...
    print '\nStep 7: On DUT: Execute +SRSPPSTART with the actived session'
    SagSendAT(uart_com, "AT+SRSPPSTART=1\r")
    SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 2000)
    SagSendAT(uart_com, "Testing SRSPPSTART")
    SagSendAT(uart_com, "+++")
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    SagWaitnMatchResp(aux1_com, ['+SRSPP_DATA: 1,18,Testing SRSPPSTART\r\n'], 2000)
    
    print '\nStep 8: Close SPP connection'
    SagSendAT(aux1_com, "AT+SRSPPCLOSE=1\r")
    SagWaitnMatchResp(aux1_com, ['\r\n+SRSPPCLOSE: 1,0\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['OK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+SRSPPCLOSE: 1,0\r\n'], 2000)

    print '\nStep 8: On DUT: Execute +SRSPPSND to send data to AUX1'
    SagSendAT(uart_com, "AT+SRSPPSND=1, Hello AUX1\r")
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 922\r\n'], 2000)
    
    print '\nStep 9: On AUX1: Execute +SRSPPSND to send data to AUX1'
    SagSendAT(aux1_com, "AT+SRSPPSND=1, Hello DUT\r")
    SagWaitnMatchResp(aux1_com, ['\r\n+CME ERROR: 922\r\n'], 2000)
    
    print '\nStep 10: Delete SPP session configuration'
    print 'On DUT ...'
