...
# A_BX_EmbeddedSW_SPP_0012                      Check the module can establish SPP connection to Sony android smartphone
# 
# Requirement
# 1 module, Sony smartphone that is installed MelodyClassic
#    
# Author: ptnlam
#
# Jira ticket:
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SPP_0012
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SPP_0012"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check the module can establish SPP connection to Sony android smartphone" % test_ID
    print "*****************************************************************************************************************"
