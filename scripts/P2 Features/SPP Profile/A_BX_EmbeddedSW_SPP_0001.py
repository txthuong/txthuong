...
# A_BX_EmbeddedSW_SPP_0001                      Check Syntax of write +SRSPPCNX command with valid value, invalid value and value out of range
# 
# Requirement
# 2 Euler modules
#    
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SPP_0001
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SPP_0001"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check Syntax of write +SRSPPCNX command with valid value, invalid value and value out of range" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 5: DUT: Activate connection to AUX with invalid value\n"
    SagSendAT(uart_com, 'AT+SRSPPCNX=!1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 916\r\n'], 2000)
    
    print "\nStep 6: DUT: Activate connection to AUX with out of range value\n"
    SagSendAT(uart_com, 'AT+SRSPPCNX=-1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 910\r\n'], 2000)
    
    print "\nStep 7: DUT: Activate connection to AUX with invalid <session_id>\n"
    SagSendAT(uart_com, 'AT+SRSPPCNX=2\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 910\r\n'], 2000)
    
    print "\nStep 8: DUT: Activate connection to AUX with valid value\n"
    SagSendAT(uart_com, 'AT+SRSPPCNX=1\r')
    ...
    print "\nStep 10: DUT: Delete SPP connection\n"
