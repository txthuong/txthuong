...
# A_BX_EmbeddedSW_SPP_0015                      Check the module can establish SPP connection to Iphone android smartphone
# 
# Requirement
# 1 module, Iphone smartphone that is installed MelodyClassic
#    
# Author: ptnlam
#
# Jira ticket:
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SPP_0015
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SPP_0015"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Check the module can establish SPP connection to Iphone android smartphone" % test_ID
    print "*****************************************************************************************************************"
