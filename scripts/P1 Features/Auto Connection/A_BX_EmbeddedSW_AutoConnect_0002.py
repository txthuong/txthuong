...
# A_BX_EmbeddedSW_AutoConnect_0002              Check BX module should auto-connect to Wifi access point when it's powered on
#
# Requirement
#   1 Euler module
#   1 AP
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AutoConnect_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AutoConnect_0002"
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: Check BX module should auto-connect to Wifi access point when it's powered on" % test_ID
    print "***********************************************************************************************************************"
