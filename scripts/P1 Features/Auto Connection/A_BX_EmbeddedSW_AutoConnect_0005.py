...
# A_BX_EmbeddedSW_AutoConnect_0005              Check BX module should auto-connect to Wifi of other Euler module (hidden SSID) when it's powered on
#
# Requirement
#   2 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_AutoConnect_0005
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_AutoConnect_0005"
...
try:
    ...
    if '"%s"' % wifi_ssid in response:
        raise Exception("----> Problem: AUX Access Point not in hidden SSID mode !!!")
