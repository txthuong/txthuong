...
# A_BX_EmbeddedSW_KTCP_SRVREQ_0001              To check notification with URC "+KTCP_SRVREQ" is received in server when a client requests a connection to the sever, and the connection is automatically accepted
#
# Requirement
#   2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCP_SRVREQ_0001
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCP_SRVREQ_0001"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s:To check notification with URC +KTCP_SRVREQ is received in server when a client requests a connection to the sever, and the connection is automatically accepted" % test_ID
    print "***************************************************************************************************************"
    ...
    print '\nStep 12: AUX: Close created session\n'
    SagSendAT(aux1_com, 'AT+KTCPCLOSE=1,1\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+KTCP_NOTIF: 2,4\r\n'], 2000)
    
    print '\nStep 13: AUX: Delete TCP Connection after closing it\n'
    SagSendAT(aux1_com, 'AT+KTCPDEL=1\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 14: DUT: Close created session\n'
    SagSendAT(uart_com, 'AT+KTCPCLOSE=1,0\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 15: DUT: Delete TCP Connection after closing it\n'
