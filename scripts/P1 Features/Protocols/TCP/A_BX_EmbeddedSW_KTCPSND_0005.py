...
# A_BX_EmbeddedSW_KTCPSND_0005                  To check data can be sent to HTTP server
#
# Requirement
# 1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCPSND_0005
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCPSND_0005"
...
try:
    ...
    SagSendAT(uart_com, 'AT+KTCPCFG=,0,"httpbin.org",80\r')
    SagWaitnMatchResp(uart_com, ['\r\n+KTCPCFG: 1\r\n'], 2000)
    ...
    print '\nStep 6: Send data to HTTP server\n'
    SagSendAT(uart_com, 'AT+KTCPSND=1,"1234567890\r\n"\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 3000)
    SagWaitnMatchResp(uart_com, ['\r\n+KTCP_DATA: 1,*,HTTP/1.1 400 Bad Request\r\n'], 3000)
    SagWaitnMatchResp(uart_com, ['*\r\n+KTCP_NOTIF: 1,4\r\n'], 3000)
