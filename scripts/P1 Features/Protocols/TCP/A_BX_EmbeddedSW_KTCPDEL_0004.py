...
# A_BX_EmbeddedSW_KTCPDEL_0004                  Check that +KTCPDEL supports client <tcp_session_id> 1 - 64
#
# Requirement
#   1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCPDEL_0004
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCPDEL_0004"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s:Check that +KTCPDEL supports client <tcp_session_id> 1 - 64" % test_ID
    print "***************************************************************************************************************"
    ...
    print '\nStep 6: Delete the TCP configuration with <tcp_session_id> from 1 to 64\n'
    for i in range (1,65):
