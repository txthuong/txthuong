...
# A_BX_EmbeddedSW_KTCPCNX_0005                  Check that +KTCPCNX supports client <session_id> 1 - 64
#
# Requirement
# 1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCPCNX_0005
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCPCNX_0005"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s:  Check that +KTCPCNX supports client <session_id> 1 - 64" % test_ID
    print "***************************************************************************************************************"
    ...
    SagSendAT(uart_com, 'AT+KTCPCFG=,0,"%s",%s,1,1,1\r' %(tcp_server, tcp_port))
    SagWaitnMatchResp(uart_com, ['\r\n+KTCPCFG: 1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    
    print '\nStep 5: Repeat step 4 above 63 times\n'
    for i in range(2,65):
        SagSendAT(uart_com, 'AT+KTCPCFG=,0,"%s",%s,1,1,1\r' %(tcp_server, tcp_port))
        SagWaitnMatchResp(uart_com, ['\r\n+KTCPCFG: %s\r\n' %i], 2000)
        SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
