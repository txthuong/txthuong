...
# A_BX_EmbeddedSW_KTCP_DATA_0006                To check URC "+KTCP_DATA"  with <data> is received correctly when the module receives more than 242 bytes data from server
#
# Requirement
#   2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCP_DATA_0006
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCP_DATA_0006"
...
try:
    ...
    print '\nStep 12: DUT: Send data to CLIENT with 242 byte\n'
    SagSendAT(uart_com, 'AT+KTCPSND=2,12123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 13: AUX: Check URC "+KTCP_DATA" is received\n'
    SagWaitnMatchResp(aux1_com, ['\r\n+KTCP_DATA: 1,242,12123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890\r\n'], 2000)
    
    print '\nStep 14: DUT: Send data to CLIENT with more than 242 byte (250 byte)\n'
    SagSendAT(uart_com, 'AT+KTCPSND=2,1234512345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 15: AUX: Check URC "+KTCP_DATA" is received\n'
    SagWaitnMatchResp(aux1_com, ['\r\n+KTCP_DATA: 1,242,12345123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567\r\n'], 2000)
