...
# A_BX_EmbeddedSW_KTCPCNX_0006                  To check "+KTCPCNX" could start TCP connection after TCP server down and then restart
#
# Requirement
# 1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCPCNX_0006
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCPCNX_0006"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s: To check +KTCPCNX could start TCP connection after TCP server down and then restart" % test_ID
    print "***************************************************************************************************************"
    ...
    print '\nStep 7: Close the TCP sever listening port\n'
    time.sleep(20)
    ...
    print '\nStep 9: Open the TCP sever listening port\n'
    wx.MessageBox('Open the TCP sever listening port then click "OK"', 'Info',wx.OK)
    time.sleep(5)
    
    print '\nStep 10: Start TCP Connection\n'
    SagSendAT(uart_com, 'AT+KTCPCNX=1\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
