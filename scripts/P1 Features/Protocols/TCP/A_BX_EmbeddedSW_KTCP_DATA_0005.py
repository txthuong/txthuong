...
# A_BX_EmbeddedSW_KTCP_DATA_0005                To check URC "+KTCP_DATA"  with <data> is received correctly when the module receives data from server when send special characters (hex values)
#
# Requirement
#   2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCP_DATA_0005
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCP_DATA_0005"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s:To check URC +KTCP_DATA  with <data> is received correctly when the module receives data from server when send special characters (hex values)" % test_ID
    print "***************************************************************************************************************"
    ...
    print '\nStep 12: DUT: Send data to CLIENT with special characters (hex values)\n'
    SagSendAT(uart_com, 'AT+KTCPSND=2,"abcdefg&\\41\\42\\43\\44\\45\\46\\47"\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 13: AUX: Check URC "+KTCP_DATA" is received\n'
    SagWaitnMatchResp(aux1_com, ['\r\n+KTCP_DATA: 1,15,abcdefg&ABCDEFG\r\n'], 2000)
    ...
    print '\nStep 15: AUX: Delete TCP Connection after closing it\n'
    SagSendAT(aux1_com, 'AT+KTCPDEL=1\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 16: DUT: Close created session\n'
    SagSendAT(uart_com, 'AT+KTCPCLOSE=1,0\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 17: DUT: Delete TCP Connection after closing it\n'
