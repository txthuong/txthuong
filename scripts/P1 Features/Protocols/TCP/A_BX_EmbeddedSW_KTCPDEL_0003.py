...
# A_BX_EmbeddedSW_KTCPDEL_0003                  To check TCP session can be deleted without starting the TCP session by the AT command "+KTCPDEL"
#
# Requirement
#   1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCPDEL_0003
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCPDEL_0003"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s:To check TCP session can be deleted without starting the TCP session by the AT command +KTCPDEL" % test_ID
    print "***************************************************************************************************************"
    ...
    print '\nStep 6: Delete TCP Connection after closing it\n'
