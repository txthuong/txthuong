...
# A_BX_EmbeddedSW_KTCP_DATA_0008                To check notification with URC "+KTCP_DATA"  with <data> is correct when the received data = 100KB
#
# Requirement
#   2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCP_DATA_0008
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_KTCP_DATA_0008"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: To check notification with URC "+KTCP_DATA"  with <data> is correct when the received data = 100KB' % test_ID
    print "***************************************************************************************************************"
