...
# A_BX_EmbeddedSW_KTCPSND_0002                  To check data can be sent from server module to client module
#
# Requirement
# 2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCPSND_0002
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCPSND_0002"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s:To check data can be sent from server module to client module" % test_ID
    print "***************************************************************************************************************"
    ...
    SagSendAT(uart_com, 'AT+KTCPSND=2,"A_BX_EmbeddedSW_KTCPSND_0002"\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    print '\nAUX:  Incoming data through a TCP connection notification is received\n'
    SagWaitnMatchResp(aux1_com, ['\r\n+KTCP_DATA: 1,28,A_BX_EmbeddedSW_KTCPSND_0002\r\n'], 2000)
