...
# A_BX_EmbeddedSW_KTCPCLOSE_0004                To check the command "+KTCPCLOSE" could close the TCP listening server socket
#
# Requirement
#   2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCPCLOSE_0004
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCPCLOSE_0004"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s: To check the command +KTCPCLOSE could close the TCP listening server socket" % test_ID
    print "***************************************************************************************************************"
    ...
    SagSendAT(aux1_com, 'AT+KTCPSND=1,"A_BX_EmbeddedSW_KTCPCLOSE_0004"\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 13: AUX: Check URC "+KTCP_DATA" is received\n'
    SagWaitnMatchResp(uart_com, ['\r\n+KTCP_DATA: 2,30,A_BX_EmbeddedSW_KTCPCLOSE_0004\r\n'], 2000)
