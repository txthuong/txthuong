...
# A_BX_EmbeddedSW_KTCP_DATA_0002                To check notification with URC "+KTCP_DATA"  is received once data is available in the receive buffer in DUT server from AUX client
#
# Requirement
#   2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCP_DATA_0002
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCP_DATA_0002"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s: To check notification with URC +KTCP_DATA  is received once data is available in the receive buffer in DUT server from AUX client" % test_ID
    print "***************************************************************************************************************"
    ...
    SagSendAT(aux1_com, 'AT+KTCPSND=1,"A_BX_EmbeddedSW_KTCP_DATA_0001"\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 13: DUT: Check URC "+KTCP_DATA" is received\n'
    SagWaitnMatchResp(uart_com, ['\r\n+KTCP_DATA: 2,30,A_BX_EmbeddedSW_KTCP_DATA_0001\r\n'], 2000)
