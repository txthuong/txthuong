...
# A_BX_EmbeddedSW_KTCPCNX_0001                  To check syntax and basic functionality for the AT command "+KTCPCNX", start TCP Connection
#
# Requirement
#   1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCPCNX_0001
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCPCNX_0001"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s:To check syntax and basic functionality for the AT command +KTCPCNX, start TCP Connection." % test_ID
    print "***************************************************************************************************************"
    ...
    SagSendAT(uart_com, 'AT+KTCPCNX?\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    ...
    SagSendAT(uart_com, 'AT+KTCPCNX=1,1,1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 910\r\n'], 2000)
    ...
    print '\nStep 10: Checking <tcp_session_id> from 1 to 20\n'
    for i in range (1,20):
        SagSendAT(uart_com, 'AT+KTCPCNX=%s\r' %i)
        SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 910\r\n'], 2000)
    
    print '\nStep 11: TCP Connection Configuration\n'
    SagSendAT(uart_com, 'AT+KTCPCFG=,0,"%s",%s\r' %(tcp_server, tcp_port))
    SagWaitnMatchResp(uart_com, ['\r\n+KTCPCFG: 1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    
    print '\nStep 12: Start TCP Connection\n'
    ...
    print '\nStep 14: Delete the TCP connection\n'
