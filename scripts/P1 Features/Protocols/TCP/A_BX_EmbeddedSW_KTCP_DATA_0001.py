...
# A_BX_EmbeddedSW_KTCP_DATA_0001                To check notification with URC "+KTCP_DATA" is received once data is available in the receive buffer in AUX client from DUT server
#
# Requirement
#   2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCP_DATA_0001
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCP_DATA_0001"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s: To check notification with URC +KTCP_DATA is received once data is available in the receive buffer in AUX client from DUT server" % test_ID
    print "***************************************************************************************************************"
    ...
    SagSendAT(uart_com, 'AT+KTCPSND=2,"A_BX_EmbeddedSW_KTCP_DATA_0001"\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 13: AUX: Check URC "+KTCP_DATA" is received\n'
    SagWaitnMatchResp(aux1_com, ['\r\n+KTCP_DATA: 1,30,A_BX_EmbeddedSW_KTCP_DATA_0001\r\n'], 2000)
