...
# A_BX_EmbeddedSW_KTCPSND_0003                  To check data can be sent from client module to server module
#
# Requirement
# 2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCPSND_0003
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCPSND_0003"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s: To check data can be sent from client module to server module" % test_ID
    print "***************************************************************************************************************"
    ...
    SagSendAT(aux1_com, 'AT+KTCPSND=1,"A_BX_EmbeddedSW_KTCPSND_0003"\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)

    print '\nAUX:  Incoming data through a TCP connection notification is received\n'
    SagWaitnMatchResp(uart_com, ['\r\n+KTCP_DATA: 2,28,A_BX_EmbeddedSW_KTCPSND_0003\r\n'], 2000)
