...
# A_BX_EmbeddedSW_KTCP_DATA_0003                To check notification with URC "+KTCP_DATA"  shall not be received if no data is sent
#
# Requirement
#   2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCP_DATA_0003
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCP_DATA_0003"
...
try:
    ...
    SagSendAT(aux1_com, 'AT+KTCPSND=1,""\r')
    SagWaitnMatchResp(aux1_com, ['\r\n+CME ERROR: 903\r\n'], 2000)
    
    print '\nStep 13: DUT: Check URC "+KTCP_DATA" is received\n'
    response = SagWaitResp(uart_com, ['*'], 60000)
