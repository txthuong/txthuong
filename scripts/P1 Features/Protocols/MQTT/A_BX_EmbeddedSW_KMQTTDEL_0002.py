...
# A_BX_EmbeddedSW_KMQTTDEL_0002     Check that +KMQTTDEL supports delete specified MQTT session
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KMQTTDEL_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_KMQTTDEL_0002"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KMQTTDEL supports delete specified MQTT session' % test_ID
    print "***************************************************************************************************************"
    ...
    for version in (3, 4):
        ...
        print "\nStep 4: Delete the MQTT connection"
        SagSendAT(uart_com, 'AT+KMQTTDEL=1\r')
        SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)

    print "\nStep 5: Query MQTT connection configuration"
    SagSendAT(uart_com, 'AT+KMQTTCFG?\r')
