...
# A_BX_EmbeddedSW_KMQTTCNX_0002     Check that +KMQTTCNX command can start a MQTT connection
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KMQTTCNX_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_KMQTTCNX_0002"
