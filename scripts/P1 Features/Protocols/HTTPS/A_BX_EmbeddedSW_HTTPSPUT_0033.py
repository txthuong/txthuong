...
# A_BX_EmbeddedSW_HTTPSPUT_0033            Check that +KHTTPSPUT works with a server by <cipher_suite> TLS_DHE_RSA_WITH_AES_128_CCM_8
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSPUT_0033
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSPUT_0033"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSPUT works with a server by <cipher_suite> TLS_DHE_RSA_WITH_AES_128_CCM_8' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSPUT works with a server by <cipher_suite> TLS_DHE_RSA_WITH_AES_128_CCM_8"
