...
# A_BX_EmbeddedSW_HTTPSGET_0015          Check that +KHTTPSGET works with a server by <cipher_suite> AES256-SHA
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSGET_0015
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSGET_0015"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSGET works with a server by <cipher_suite> AES256-SHA' % test_ID
    print "***************************************************************************************************************"
    ...
    SagSleep(5000)
    https_cmd = 'cmd /c start python httpsd.py -x ./server.pem -c AES256-SHA -p '+str(https_port)
    ...
    print "\nCheck that +KHTTPSGET works with supported <cipher_suite> AES256-SHA"
