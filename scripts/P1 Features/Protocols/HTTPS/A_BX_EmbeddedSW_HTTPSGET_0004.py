...
# A_BX_EmbeddedSW_HTTPSGET_0004            Check that +KHTTPSGET can send data to HTTPS server
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSGET_0004
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSGET_0004"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSGET can send data to HTTPS server' % test_ID
    print "***************************************************************************************************************"
    ...
    data = 'euler'
    print "\nStep 4: Perform +KHTTPSGET to send data to HTTPS server"
    SagSendAT(uart_com, 'AT+KHTTPSGET=1,"/get?Param=%s"\r' % data)
    SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['HTTP/1.1 200 OK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['*"Param": "%s"' % data], 2000)
    SagWaitnMatchResp(uart_com, ['*\r\nOK\r\n'], 2000)
