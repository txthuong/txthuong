...
# A_BX_EmbeddedSW_HTTPSPOST_0002           Check that +KHTTPSPOST can send data to HTTPS server
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSPOST_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSPOST_0002"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSPOST can send data to HTTPS server' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 6: Run +KHTTPSPOST to send data to HTTPS server"
    connected = False
    ...
    if not connected:
        ...
        if not SagWaitnMatchResp(uart_com, ["\r\nOK\r\n"], 20000):
            SagSleep(300000)
        raise Exception('\nFailed to execute command +KHTTPSPOST !!!\n')
