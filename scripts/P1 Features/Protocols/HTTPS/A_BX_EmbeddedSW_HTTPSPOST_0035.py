...
# A_BX_EmbeddedSW_HTTPSPOST_0035           Check that +KHTTPSPOST works with a server by <cipher_suite> TLS_RSA_WITH_AES_256_CBC_SHA256
#
# Requirement
#   1 Euler module
#   1 AP running at 2.4GHz band
#   1 Python HTTPS server supports TLS_RSA_WITH_AES_256_CBC_SHA256
#
# Author: txthuong
#
# Jira ticket:
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSPOST_0035
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSPOST_0035"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSPOST works with a server by <cipher_suite> TLS_RSA_WITH_AES_256_CBC_SHA256' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSPOST works with a server by <cipher_suite> TLS_RSA_WITH_AES_256_CBC_SHA256\n"
