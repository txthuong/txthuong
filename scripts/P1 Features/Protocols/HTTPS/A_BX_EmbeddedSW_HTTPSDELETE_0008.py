...
# A_BX_EmbeddedSW_HTTPSDELETE_0008       Check that +KHTTPSDELETE works with a server by <cipher_suite> RC4-MD5
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSDELETE_0008
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSDELETE_0008"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSDELETE works with a server by <cipher_suite> RC4-MD5' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSDELETE works with supported <cipher_suite> RC4-MD5"
    for cipher_suite in all_cipher_suite:
        ...
        if cipher_suite in supported_cipher_suite:
            ...
            if not SagWaitnMatchResp(uart_com, ['\r\n+KHTTPSCFG: 1,,"%s",%s,1,%d,1,,,0,0\r\n' % (https_server2, https_port, cipher_suite)], 2000):
                print 'Problem: +KHTTPSDELETE works with server by unsupported <cipher_suite> !!!\n'
                SagSendAT(uart_com, "AT+KHTTPSCLOSE=1\r")
            SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
