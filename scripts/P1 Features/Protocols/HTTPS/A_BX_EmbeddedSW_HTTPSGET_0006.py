...
# A_BX_EmbeddedSW_HTTPSGET_0006            Check that +KHTTPSGET reports HTTP status codes
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSGET_0006
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSGET_0006"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSGET reports HTTP status codes' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 4: Perform +KHTTPSGET for a HTTP status code 404"
    SagSendAT(uart_com, 'AT+KHTTPSGET=1,"/a-path-that-not-exists/"\r')
    SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['HTTP/1.1 404 NOT FOUND\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['*The requested URL was not found on the server.  If you entered the URL manually please check your spelling and try again'], 2000)
    SagWaitnMatchResp(uart_com, ['*\r\nOK\r\n'], 2000)
