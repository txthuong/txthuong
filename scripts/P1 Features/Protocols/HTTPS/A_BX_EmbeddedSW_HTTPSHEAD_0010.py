...
# A_BX_EmbeddedSW_HTTPSHEAD_0010         Check that +KHTTPSHEAD works with a server by <cipher_suite> AES128-SHA
#
# Requirement
#   1 Euler module
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSHEAD works with a server by <cipher_suite> AES128-SHA' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSHEAD works with supported <cipher_suite> AES128-SHA"
