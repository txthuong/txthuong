...
# A_BX_EmbeddedSW_HTTPSCNX_0026          Check that +KHTTPSCNX works with a server by <cipher_suite> TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSCNX_0026
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSCNX_0026"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSCNX works with a server by <cipher_suite> TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSCNX works with supported <cipher_suite> TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256"
