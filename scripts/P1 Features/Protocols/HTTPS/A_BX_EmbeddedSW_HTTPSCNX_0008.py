...
# A_BX_EmbeddedSW_HTTPSCNX_0008          Check that +KHTTPSCNX works with supported <cipher_suite> RC4-MD5
#
# Requirement
#   1 Euler module
#   1 AP running at 2.4GHz band
#   1 Python HTTPS server supports AES256-SHA
#
# Author: txthuong
#
# Jira ticket:
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSCNX works with supported <cipher_suite> AES256-SHA' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSCNX works with supported <cipher_suite> AES256-SHA"
