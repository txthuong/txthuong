...
# A_BX_EmbeddedSW_HTTPSHEAD_0020         Check that +KHTTPSHEAD works with a server by <cipher_suite> TLS_ECDHE_ECDSA_WITH_AES_256_CCM_8
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSHEAD_0020
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSHEAD_0020"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSHEAD works with a server by <cipher_suite> TLS_ECDHE_ECDSA_WITH_AES_256_CCM_8' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSHEAD works with a server by <cipher_suite> TLS_ECDHE_ECDSA_WITH_AES_256_CCM_8"
