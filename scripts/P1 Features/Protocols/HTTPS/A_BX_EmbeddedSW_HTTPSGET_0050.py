...
# A_BX_EmbeddedSW_HTTPSGET_0050          Check that +KHTTPSGET does not work with a server by unsupported <cipher_suite>
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSGET_0050
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSGET_0050"
