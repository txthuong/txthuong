...
# A_BX_EmbeddedSW_HTTPSDELETE_0021       Check that +KHTTPSDELETE works with a server by <cipher_suite> TLS_DHE_RSA_WITH_AES_256_CCM_8
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSDELETE_0021
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSDELETE_0021"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSDELETE works with a server by <cipher_suite> TLS_DHE_RSA_WITH_AES_256_CCM_8' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSDELETE works with a server by <cipher_suite> TLS_DHE_RSA_WITH_AES_256_CCM_8"
