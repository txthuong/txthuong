...
# A_BX_EmbeddedSW_HTTPSHEAD_0011         Check that +KHTTPSHEAD works with a server by <cipher_suite> TLS_DHE_RSA_WITH_AES_256_GCM_SHA384
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSHEAD_0011
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSHEAD_0011"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSHEAD works with a server by <cipher_suite> TLS_DHE_RSA_WITH_AES_256_GCM_SHA384' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSHEAD works with a server by <cipher_suite> TLS_DHE_RSA_WITH_AES_256_GCM_SHA384"
