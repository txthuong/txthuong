...
# A_BX_EmbeddedSW_HTTPSPUT_0036            Check that +KHTTPSPUT works with a server by <cipher_suite> TLS_RSA_WITH_AES_256_CBC_SHA256
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSPUT_0036
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSPUT_0036"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSPUT works with a server by <cipher_suite> TLS_RSA_WITH_AES_256_CBC_SHA256' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSPUT works with a server by <cipher_suite> TLS_RSA_WITH_AES_256_CBC_SHA256"
