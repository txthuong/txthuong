...
# A_BX_EmbeddedSW_HTTPSCNX_0012          Check that +KHTTPSCNX works with a server by <cipher_suite> TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSCNX_0012
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSCNX_0012"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSCNX works with a server by <cipher_suite> TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSCNX works with supported <cipher_suite> TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384"
