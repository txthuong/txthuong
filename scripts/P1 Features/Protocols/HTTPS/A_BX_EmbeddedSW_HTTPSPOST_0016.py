...
# A_BX_EmbeddedSW_HTTPSPOST_0016           Check that +KHTTPSPOST works with a server by <cipher_suite> TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA
#
# Requirement
#   1 Euler module
#   1 AP running at 2.4GHz band
#   1 Python HTTPS server supports TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA
#
# Author: txthuong
#
# Jira ticket:
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSPOST_0016
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSPOST_0016"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSPOST works with a server by <cipher_suite> TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA' % test_ID
    print "***************************************************************************************************************"
    ...
    SagSleep(5000)
    # Start HTTPS service
    https_cmd = 'cmd /c start httpd -f conf/httpd-TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA.conf'
    ...
    supported_cipher_suite = (0, 10)

    print "\nCheck that +KHTTPSPOST works with a server by <cipher_suite> TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA\n"
