...
# A_BX_EmbeddedSW_HTTPSCNX_0032          Check that +KHTTPSCNX works with a server by <cipher_suite> TLS_DHE_RSA_WITH_AES_128_CCM_8
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSCNX_0032
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSCNX_0032"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSCNX works with a server by <cipher_suite> TLS_DHE_RSA_WITH_AES_128_CCM_8' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSCNX works with supported <cipher_suite> TLS_DHE_RSA_WITH_AES_128_CCM_8"
