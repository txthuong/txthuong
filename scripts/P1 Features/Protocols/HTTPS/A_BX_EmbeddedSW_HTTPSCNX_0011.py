...
# A_BX_EmbeddedSW_HTTPSCNX_0011          Check that AT+KHTTPSCNX command can start a HTTPS connection
#
# Requirement
#   1 Euler module
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that AT+KHTTPSCNX command can start a HTTPS connection' % test_ID
    print "***************************************************************************************************************"
