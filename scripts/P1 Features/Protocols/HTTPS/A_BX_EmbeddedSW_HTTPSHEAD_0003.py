...
# A_BX_EmbeddedSW_HTTPSHEAD_0003           Check that +KHTTPSHEAD properly handles invalid IP address
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSHEAD_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSHEAD_0003"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSHEAD properly handles invalid IP address' % test_ID
    print "***************************************************************************************************************"
    ...
    SagSendAT(uart_com, 'AT+KHTTPSCFG=,%s\r' % invalid_ip_address)
    SagWaitnMatchResp(uart_com, ['\r\n+KHTTPSCFG: 1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    ...
    print "\nStep 4: Perform +KHTTPSHEAD to HTTPS server by invalid IP address"
    ...
    if not SagWaitnMatchResp(uart_com, ['\r\n+KHTTPSCFG: 1,,"%s",443,0,0,1,,,0,0\r\n' % invalid_ip_address], 2000):
        print 'PROBLEM: +KHTTPSHEAD did not handle invalid IP address properly !!!\n'
