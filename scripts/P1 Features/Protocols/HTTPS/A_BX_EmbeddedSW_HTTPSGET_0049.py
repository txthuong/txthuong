...
# A_BX_EmbeddedSW_HTTPSGET_0049          Check that +KHTTPSGET works with a server by <cipher_suite> TLS_PSK_WITH_AES_128_CBC_SHA
#
# Requirement
#   1 Euler module
#   1 AP running at 2.4GHz band
#   1 HTTPS server supports TLS_PSK_WITH_AES_128_CBC_SHA
#
# Author: txthuong
#
# Jira ticket:
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSGET_0049
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSGET_0049"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSGET works with a server by <cipher_suite> TLS_PSK_WITH_AES_128_CBC_SHA' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSGET works with HTTPS server supported <cipher_suite> TLS_PSK_WITH_AES_128_CBC_SHA"
