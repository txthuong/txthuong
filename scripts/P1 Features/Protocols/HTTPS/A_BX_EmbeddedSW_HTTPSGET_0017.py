...
# A_BX_EmbeddedSW_HTTPSGET_0017          Check that +KHTTPSGET works with a server by <cipher_suite> TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384
#
# Requirement
#   1 Euler module
#   1 AP running at 2.4GHz band
#   1 HTTPS server supports TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384
#
# Author: txthuong
#
# Jira ticket:
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSGET_0017
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSGET_0017"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSGET works with a server by <cipher_suite> TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSGET works with HTTPS server supported <cipher_suite> TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384"
