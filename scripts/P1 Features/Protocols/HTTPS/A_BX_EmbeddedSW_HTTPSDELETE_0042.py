...
# A_BX_EmbeddedSW_HTTPSDELETE_0042       Check that +KHTTPSDELETE works with a server by <cipher_suite> TLS_RSA_WITH_AES_128_CBC_SHA256
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSDELETE_0042
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSDELETE_0042"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSDELETE works with a server by <cipher_suite> TLS_RSA_WITH_AES_128_CBC_SHA256' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSDELETE works with a server by <cipher_suite> TLS_RSA_WITH_AES_128_CBC_SHA256"
