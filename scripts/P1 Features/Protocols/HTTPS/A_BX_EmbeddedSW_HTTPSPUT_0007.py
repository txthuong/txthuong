...
# A_BX_EmbeddedSW_HTTPSPUT_0007            Check that +KHTTPSPUT does not work with server that is unsupported <cipher_suite>
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSPUT_0007
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSPUT_0007"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSPUT does not work with server that is unsupported <cipher_suite>' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSPUT does not work with a server by unsupported <cipher_suite>"
    for cipher_suite in all_cipher_suite:
        ...
        print "\nStep 4: Running +KHTTPSPUT with <cipher_suite> %d..." % cipher_suite
