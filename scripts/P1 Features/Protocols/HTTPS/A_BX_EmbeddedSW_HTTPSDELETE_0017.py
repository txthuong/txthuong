...
# A_BX_EmbeddedSW_HTTPSDELETE_0017       Check that +KHTTPSDELETE works with a server by <cipher_suite> TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSDELETE_0017
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSDELETE_0017"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSDELETE works with a server by <cipher_suite> TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSDELETE works with a server by <cipher_suite> TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA"
