...
# A_BX_EmbeddedSW_HTTPSPOST_0039           Check that +KHTTPSPOST works with a server by <cipher_suite> TLS_RSA_WITH_AES_128_CCM
#
# Requirement
#   1 Euler module
#   1 AP running at 2.4GHz band
#   1 Python HTTPS server supports TLS_RSA_WITH_AES_128_CCM
#
# Author: txthuong
#
# Jira ticket:
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSPOST_0039
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSPOST_0039"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSPOST works with a server by <cipher_suite> TLS_RSA_WITH_AES_128_CCM' % test_ID
    print "***************************************************************************************************************"
    ...
    SagSleep(5000)
    # Start HTTPS service
    https_cmd = 'cmd /c start httpd -f conf/httpd-TLS_RSA_WITH_AES_128_CCM.conf'
    ...
    supported_cipher_suite = (0, 53)

    print "\nCheck that +KHTTPSPOST works with a server by <cipher_suite> TLS_RSA_WITH_AES_128_CCM\n"
