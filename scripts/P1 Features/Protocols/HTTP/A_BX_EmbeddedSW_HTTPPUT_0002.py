...
# A_BX_EmbeddedSW_HTTPPUT_0002             Check that AT+KHTTPPUT command can access a HTTP server by plain domain name
#
# Requirement
#   1 Euler module
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that AT+KHTTPPUT command can access a HTTP server by plain domain name' % test_ID
    print "***************************************************************************************************************"
