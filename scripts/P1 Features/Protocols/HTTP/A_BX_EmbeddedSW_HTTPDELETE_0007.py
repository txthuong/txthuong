...
# A_BX_EmbeddedSW_HTTPDELETE_0007          Check that +KHTTPDELETE properly handles invalid domain name
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPDELETE_0007
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPDELETE_0007"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPDELETE properly handles invalid domain name' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 2: Configure a HTTP connection with an invalid domain name"
    SagSendAT(uart_com, 'AT+KHTTPCFG=,%s\r' % invalid_domain)
    SagWaitnMatchResp(uart_com, ['\r\n+KHTTPCFG: 1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    ...
    if not SagWaitnMatchResp(uart_com, ['\r\n+KHTTPCFG: 1,,"%s",80,0,,,0,0\r\n' % invalid_domain], 2000):
        print 'Problem: +KHTTPDELETE does not handle invalid domain properly !!!\n'
