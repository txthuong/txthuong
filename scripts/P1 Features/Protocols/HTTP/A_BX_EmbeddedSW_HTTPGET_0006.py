...
# A_BX_EmbeddedSW_HTTPGET_0006           Check that +KHTTPGET supports a non-80 HTTP port
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPGET_0006
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPGET_0006"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPGET supports a non-80 HTTP port' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 4: Perform +KHTTPGET"
    SagSendAT(uart_com, 'AT+KHTTPGET=1,"/"\r')
    if not SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 20000):
        print 'Problem: Failed to check +KHTTPGET with non-80 port HTTP connection !!!\n'
    else:
