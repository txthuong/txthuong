...
# A_BX_EmbeddedSW_HTTPGET_0009             Check that +KHTTPGET properly handles invalid IP address
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPGET_0009

test_ID = "A_BX_EmbeddedSW_HTTPGET_0009"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPGET properly handles invalid IP address' % test_ID
    print "***************************************************************************************************************"
    ...
    if not SagWaitnMatchResp(uart_com, ['\r\n+KHTTPCFG: 1,,"%s",80,0,,,0,0\r\n' % invalid_ip_addr], 2000):
        print 'Problem: +KHTTPGET does not handle invalid IP address properly !!!\n'
