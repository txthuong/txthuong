...
# A_BX_EmbeddedSW_Concurrent_BT_BLE_0005        Verify module can concurrently connect to BT classic devices and receive connection from BLE devices
#
# Requirement
#   3 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_Concurrent_BT_BLE_0005
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_Concurrent_BT_BLE_0005"
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: Verify module can concurrently connect to BT classic devices and receive connection from BLE devices" % test_ID
    print "***********************************************************************************************************************"
    ...
    print '\nOn DUT...'
    print 'Step 10: Start advertising'
    ...
    print '\nOn DUT...'
    print 'Step 14: Start advertising'
    SagSendAT(uart_com, "AT+SRBLEADV=1\r")
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
