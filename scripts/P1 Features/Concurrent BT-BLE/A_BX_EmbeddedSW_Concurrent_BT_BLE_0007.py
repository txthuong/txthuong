...
# A_BX_EmbeddedSW_Concurrent_BT_BLE_0007        Verify module can concurrently send/receive connection from BT classic devices and  BLE devices
#
# Requirement
#   3 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_Concurrent_BT_BLE_0007
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_Concurrent_BT_BLE_0007"
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: Verify module can concurrently send/receive connection from BT classic devices and  BLE devices" % test_ID
    print "***********************************************************************************************************************"
    ...
    SagWaitnMatchResp(uart_com, ['\r\n+SRBTCFG: 1,0,"%s",SPP,0' % aux1_bluetooth_address], 3000)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 3000)
    ...
    SagWaitnMatchResp(uart_com, ['\r\n+SRBTCFG: 2,0,"%s",SPP,0' % aux2_bluetooth_address], 3000)
    SagWaitnMatchResp(uart_com, ['\r\n+SRSPPCNX: 2,1,*\r\n'], 10000)
    #SagWaitnMatchResp(uart_com, ['OK\r\n'], 3000)
    ...
    print '\nOn DUT...'
    print 'Step 11: Configure an BLE connection to AUX1'
