...
# A_BX_EmbeddedSW_Concurrent_BT_BLE_0002        Verify module can concurrently connect to BLE devices and  BT classic devices
#
# Requirement
#   3 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_Concurrent_BT_BLE_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_Concurrent_BT_BLE_0002"
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: Verify module can concurrently connect to BLE devices and  BT classic devices" % test_ID
    print "***********************************************************************************************************************"
    ...
    print '\nStep 8: Discover service on AUX2'
    SagSendAT(uart_com, "AT+SRBLEDISCSERV=2\r")
    ...
    print '\nStep 13: Configure a BT classic connection to AUX2'
    ...
    print 'On DUT...'
    SagSendAT(uart_com, "AT+SRSPPDEL=3\r")
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    ...
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    print 'On AUX1...'
    SagSendAT(aux1_com, "AT+SRSPPDEL=2\r")
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    SagSendAT(aux1_com, "AT+SRBLEDEL=1\r")
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    print 'On AUX2...'
    SagSendAT(aux2_com, "AT+SRSPPDEL=2\r")
    SagWaitnMatchResp(aux2_com, ['\r\nOK\r\n'], 2000)
