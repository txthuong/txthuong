...
# A_BX_AVMS_CNT_0023           When the polling timer expires, the device shall register or send a register update to the DM server
#
# Requirement
#   1 Euler module
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: When the polling timer expires, the device shall register or send a register update to the DM server" % test_ID
    print "***********************************************************************************************************************"
    ...
    print "\nStep 8: Check that module should connect to DM server every 2 minutes automatically"
    for i in range(0, 11):
        SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 4\r\n'], 120000)
        SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 6\r\n'], 20000)
        SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 23,1\r\n'], 20000)
