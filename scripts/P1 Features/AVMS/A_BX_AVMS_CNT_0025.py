...
# A_BX_AVMS_CNT_0025           Verify that polling mode configuration is still recorded after module resets. The connection can be automatically triggered on reboot
#
# Requirement
#   1 Euler module
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: Verify that polling mode configuration is still recorded after module resets. The connection can be automatically triggered on reboot" % test_ID
    print "***********************************************************************************************************************"
    ...
    print "\nStep 10: Check that the connection can be automatically triggered on reboot"
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 4\r\n'], 120000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 6\r\n'], 20000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 23,1\r\n'], 20000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 8\r\n'], 90000)

    print "\nStep 11: Query Device Services configuration"
    SagSendAT(uart_com, 'AT+WDSC?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 0,0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 1,0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 2,0\r\n'], 2000)
    ...
    print "\nStep 12: Disable the polling mode"
