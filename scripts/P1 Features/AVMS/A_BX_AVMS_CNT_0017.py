...
# A_BX_AVMS_CNT_0017           In each AVMS session registration, the device and the server shall authenticate each other
#
# Requirement
#   1 Euler module
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: In each AVMS session registration, the device and the server shall authenticate each other" % test_ID
    print "***********************************************************************************************************************"
    ...
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 4\r\n'], 20000)
    if SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 6\r\n'], 20000):
        print '\n----> Authentication has succeeded and session with the server started\n'
    else:
        print '\n----> Problem: Authentication has failed !!!\n'
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 23,1\r\n'], 20000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 8\r\n'], 120000)
