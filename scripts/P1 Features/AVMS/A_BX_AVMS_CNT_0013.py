...
# A_BX_AVMS_CNT_0013           To test the device is able to connect to DM server if a reboot occurred during previous session
#
# Requirement
#   1 Euler module
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: To test the device is able to connect to DM server if a reboot occurred during previous session" % test_ID
    print "***********************************************************************************************************************"
    ...
    print "\nStep 5: Perform a reboot while connection is still opened"
