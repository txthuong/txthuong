...
# A_BX_AVMS_CNT_0018           The device shall be able to initiate a session with the AvMS DM server in order to manage planned jobs on the AvMS DM server
#
# Requirement
#   1 Euler module
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: The device shall be able to initiate a session with the AvMS DM server in order to manage planned jobs on the AvMS DM server" % test_ID
    print "***********************************************************************************************************************"
    ...
    print "\nStep 6: Create a Synchronize Job on AVMS server"
    uid_operation = my_system.createSynchronizeJob()
    print '----> The status of Synchronize System Job is: ' + my_system.getOperationTasksDetails(uid_operation)
    ...
    print "\nStep 8: Query status of Synchronize System Job"
    if my_system.getOperationTasksDetails(uid_operation) != 'SUCCESS':
        print 'Problem: Synchronize Job is not SUCCESS !!!'
        VarGlobal.statOfItem = "NOK"
    else:
        print '----> Synchronize Job is SUCCESS'
