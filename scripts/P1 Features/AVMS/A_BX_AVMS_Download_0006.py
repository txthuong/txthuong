...
# A_BX_AVMS_Download_0006         Verify that user can configure device to require his agreement before package download. In case the user AGREES package download
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_AVMS_Download_0006
# -----------------------------------------------------------------------------------

test_ID = "A_BX_AVMS_Download_0006"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Verify that user can configure device to require his agreement before package download. In case the user AGREES package download' % test_ID
    print "***************************************************************************************************************"
