...
# A_BX_AVMS_Update_0003           Check that device upgrades a nominal firmware package with user agreement in case user delays the installation
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_AVMS_Update_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_AVMS_Update_0003"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that device upgrades a nominal firmware package with user agreement in case user delays the installation' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 6: Set user agreement for installation package"
    SagSendAT(uart_com, 'AT+WDSC=2,1\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 4000)

    print "\nStep 7: Check user agreement for package installation is activated"
    SagSendAT(uart_com, 'AT+WDSC?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 0,0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 1,0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 2,1\r\n'], 2000)
    ...
    print "\nStep 11: Delay the installation for 2 minutes"
    SagSendAT(uart_com, 'AT+WDSR=5,2\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)

    print "\nStep 12: Wait for receiving request of user agreement after 2 minutes"
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 3\r\n'], 120000)

    print "\nStep 13: Accept the installation"
    ...
    print "\nStep 14: Set user agreement for installation package to default"
    SagSendAT(uart_com, 'AT+WDSC=2,0\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 4000)

    print "\nStep 15: Query Device Services configuration"
    SagSendAT(uart_com, 'AT+WDSC?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 0,0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 1,0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 2,0\r\n'], 2000)
