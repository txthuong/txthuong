...
# A_BX_AVMS_Download_0009         Verify that after a reset while a download was delayed, the package can still be downloaded
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_AVMS_Download_0009
# -----------------------------------------------------------------------------------

test_ID = "A_BX_AVMS_Download_0009"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Verify that after a reset while a download was delayed, the package can still be downloaded' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 12: Delay the Upgrade Job for 5 minutes"
    SagSendAT(uart_com, 'AT+WDSR=2,5\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)

    print "\nStep 13: Wait 1 minutes then reset the device"
    SagSleep(60000)
    ...
    print "\nStep 14: Check the user agreement request will automatically be displayed"
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 2\r\n'], 60000)
    ...
    print "\nStep 15: Check user agreement for package download and package installation is still activated"
    SagSendAT(uart_com, 'AT+WDSC?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 0,0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 1,1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 2,1\r\n'], 2000)
    ...
    print "\nStep 17: Accept the installation"
    ...
    print "\nStep 16: Set user agreement for package download to default"
    SagSendAT(uart_com, 'AT+WDSC=1,0\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 4000)

    print "\nStep 17: Set user agreement for installation package to default"
    SagSendAT(uart_com, 'AT+WDSC=2,0\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 4000)

    print "\nStep 18: Query Device Services configuration"
    SagSendAT(uart_com, 'AT+WDSC?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 0,0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 1,0\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+WDSC: 2,0\r\n'], 2000)
