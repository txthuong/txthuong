...
# A_BX_EmbeddedSW_APmode_0027                   Use command +SRWAPNETCFG to configure the end assigned IP address with Class A and use number 255 as host IP address
#
# Requirement
# 1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_APmode_0027
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_APmode_0027"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%sUse command +SRWAPNETCFG to configure the end assigned IP address with Class A and use number 255 as host IP address" % test_ID
    print "*****************************************************************************************************************"
