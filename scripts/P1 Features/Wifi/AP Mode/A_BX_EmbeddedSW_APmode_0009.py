...
# A_BX_EmbeddedSW_APmode_0009                   Use command +SRWAPCFG to configure pass-key with mix charactes (numbers, strings, speacial characters).
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_APmode_0009
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_APmode_0009"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s:Use command +SRWAPCFG to configure pass-key with mix charactes (numbers, strings, speacial characters)" % test_ID
    print "*****************************************************************************************************************"
