...
# A_BX_EmbeddedSW_STAMode_0016                  Verify output of command +SRWSTASCN: <channel> should be displayed correctly
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_STAMode_0016 
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_STAMode_0016"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Verify output of command +SRWSTASCN: <channel> should be displayed correctly" % test_ID
    print "*****************************************************************************************************************"
    ...
    response = SagWaitResp(aux1_com, [''], 20000)
    if 'OK\r\n' not in response:
        raise Exception('\r\nFAIL\r\n')

    if SagMatchResp(response, '*+SRWSTASCN: *,3,11,"%s","%s"*' % (wifi_ssid, dut_mac_address)):
        print '\nOutput of command +SRWSTASCN: <channel> displayed correctly\n'
