...
# A_BX_EmbeddedSW_STAMode_0005                  Use command +SRWSTACFG and +SRWSTACON to configure connection to another BX module that play a role as AP and hidden SSID
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_STAMode_0005
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_STAMode_0005"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Use command +SRWSTACFG and +SRWSTACON to configure connection to another BX module that play a role as AP and hidden SSID" % test_ID
    print "*****************************************************************************************************************"
    ...
    print "\nStep 6: Use module B to scan Hidden SSID\n"
