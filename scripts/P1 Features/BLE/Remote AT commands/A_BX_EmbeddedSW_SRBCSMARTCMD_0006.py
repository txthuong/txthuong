...
# A_BX_EmbeddedSW_SRBCSMARTCMD_0006        Check syntax for command +SRBCSMARTCMD
#
# Requirement
#   2 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SRBCSMARTCMD_0006
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SRBCSMARTCMD_0006"
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: Check syntax for command +SRBCSMARTCMD" % test_ID
    print "***********************************************************************************************************************"
    ...
    print '\nStep 5: Check +SRBCSMARTCMD execute command'
    SagSendAT(uart_com, 'AT+SRBCSMARTCMD\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)

    print '\nStep 6: Check +SRBCSMARTCMD read command'
    SagSendAT(uart_com, 'AT+SRBCSMARTCMD?\r')
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)
    ...
    print '\nStep 9: Check +SRBCSMARTCMD write command with invalid parameter <command>'
    command = ['"', '"AT\\0d', '"AT\\0d""']
    for cmd in command:
        SagSendAT(uart_com, 'AT+SRBCSMARTCMD=1,"%s"\r' % cmd)
        SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)

    print '\nStep 10: Check +SRBCSMARTCMD write command with missing all parameters'
    SagSendAT(uart_com, 'AT+SRBCSMARTCMD=\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 917\r\n'], 2000)

    print '\nStep 11: Check +SRBCSMARTCMD write command with missing parameter <command>'
    SagSendAT(uart_com, 'AT+SRBCSMARTCMD=1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 917\r\n'], 2000)

    print '\nStep 12: Check +SRBCSMARTCMD write command with extra parameter'
    SagSendAT(uart_com, 'AT+SRBCSMARTCMD=1,"AT\\0d",1\r')
    SagWaitnMatchResp(uart_com, ['\r\n+CME ERROR: 915\r\n'], 2000)
    ...
    print '\nStep 16: Query BLE configuration'
    print 'On DUT...'
