...
# A_BX_EmbeddedSW_SRBCSMARTCMD_0007        Check +SRBCSMARTCMD with remote server does not support BC Smart Command
#
# Requirement
#   2 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SRBCSMARTCMD_0007
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SRBCSMARTCMD_0007"
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: Check +SRBCSMARTCMD with remote server does not support BC Smart Command" % test_ID
    print "***********************************************************************************************************************"
    ...
    print '\nOn DUT...'
    print 'Step 6: Configure an BLE connection to AUX1'
    ...
    print '\nStep 8: Send a command to the remote server that does not support BC Smart command'
    SagSendAT(uart_com, 'AT+SRBCSMARTCMD=1,"%s\\0d"\r' % command)
    SagWaitnMatchResp(uart_com, ['\r\nERROR\r\n'], 2000)

    print '\nOn AUX1...'
    print 'Step 9: Disable remote control'
