...
# A_BX_EmbeddedSW_SRBCSMARTSEND_0005       Check if module can send data to multiple devices
#
# Requirement
#   2 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SRBCSMARTSEND_0005
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SRBCSMARTSEND_0005"
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: Check if module can send data to multiple devices" % test_ID
    print "***********************************************************************************************************************"
    ...
    SagSendAT(uart_com, 'AT+SRBCSMARTSEND=1,0,"%s"\r' % data_aux1)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(aux1_com, ['+SRBCSMARTRECV: 1,1,"%s"\r\n' % data_aux1], 2000)

    print '\nStep 8: Send data to AUX2'
    SagSendAT(uart_com, 'AT+SRBCSMARTSEND=2,0,"%s"\r' % data_aux2)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
