...
# A_BX_EmbeddedSW_SRBCSMARTCMD_0003        Check if remote device can process the commands when not enable remote control 
#
# Requirement
#   2 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_SRBCSMARTCMD_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_SRBCSMARTCMD_0003"
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: Check if remote device can process the commands when not enable remote control " % test_ID
    print "***********************************************************************************************************************"
    ...
    if '+SRREMCMD:' in resp:
        print '-----> Problem: AUX1 still received remote command without enable remote control !!!'
        VarGlobal.statOfItem = "NOK"
    else:
        print '----> AUX1 module ignore remote command.'
    print '\nOn AUX1...'
    ...
    print '\nStep 10: Query BLE configuration'
    print 'On DUT...'
