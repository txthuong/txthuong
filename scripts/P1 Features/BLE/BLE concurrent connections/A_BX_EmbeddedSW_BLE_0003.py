...
try:
    ...
    SagSendAT(uart_com, "AT+SRBLECFG?\r")
    SagWaitnMatchResp(uart_com, ['\r\n+SRBLECFG: 1,0,"%s",%s' % (aux1_bluetooth_address, dut_max_mtu)], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+SRBLECFG: 2,0,"%s",%s' % (aux2_bluetooth_address, dut_max_mtu)], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+SRBLECFG: 3,0,"%s",%s' % (aux3_bluetooth_address, dut_max_mtu)], 2000)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
