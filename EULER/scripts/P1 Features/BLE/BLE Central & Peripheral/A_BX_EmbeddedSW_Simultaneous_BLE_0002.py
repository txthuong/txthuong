...
try:
    ...
    print '\nOn DUT...'
    print 'Step 4: Check URC when connect to AUX1'
    ...
    print '\nOn DUT...'
    print 'Step 7: Configure an BLE connection to AUX2'
    ...
    print '\nOn DUT...'
    print 'Step 11: Close BLE connection to AUX2'
    ...
    print '\nOn AUX1...'
    print 'Step 12: Close BLE connection to DUT'
