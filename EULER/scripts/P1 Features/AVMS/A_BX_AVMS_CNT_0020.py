...
# A_BX_AVMS_CNT_0020           To test the device is able to connect to DM server if a power off occurred during previous session
#
# Requirement
#   1 Euler module
...
try:
    ...
    print "***********************************************************************************************************************"
    print "%s: To test the device is able to connect to DM server if a power off occurred during previous session" % test_ID
    print "***********************************************************************************************************************"
    ...
    print "\nStep 5: Power Off (Unplug USB cable) module while connection is still opened"
    wx.MessageBox('Unplug then Plug in USB cable then click "OK"', 'Info',wx.OK)
    uart_com = SagOpen(aux1_com, 115200, 8, "N", 1, "None")
