...
# A_BX_AVMS_Download_0005         Verify that user can configure device to require his agreement before package download. In case the user DELAYS and AGREES package download
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_AVMS_Download_0005
# -----------------------------------------------------------------------------------

test_ID = "A_BX_AVMS_Download_0005"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Verify that user can configure device to require his agreement before package download. In case the user DELAYS and AGREES package download' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 13: Check the reception of a new user agreement for download 5 minutes later"
    SagWaitnMatchResp(uart_com, ['\r\n+WDSI: 2\r\n'], 300000)

    print "\nStep 14: Accept download"
    ...
    print "\nStep 15: Accept the installation"
