...
# A_BX_AVMS_Update_0002           Check that device upgrades a nominal firmware package with user agreement in case user agrees the installation
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_AVMS_Update_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_AVMS_Update_0002"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that device upgrades a nominal firmware package with user agreement in case user agrees the installation' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 11: Accept the installation"
    ...
    print "\nStep 12: Set user agreement for installation package to default"
