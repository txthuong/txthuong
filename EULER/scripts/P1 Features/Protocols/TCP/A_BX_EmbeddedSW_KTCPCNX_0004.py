...
# A_BX_EmbeddedSW_KTCPCNX_0004                  To start TCP client to connect to the Server module with the AT command "+KTCPCNX"
#
# Requirement
#   2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCPCNX_0004
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCPCNX_0004"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s: To start TCP client to connect to the Server module with the AT command +KTCPCNX" % test_ID
    print "***************************************************************************************************************"
    ...
    print '\nStep 12: AUX: Delete TCP Connection after closing it\n'
    ...
    print '\nStep 14: DUT: Delete TCP Connection after closing it\n'
