...
# A_BX_EmbeddedSW_KTCP_SRVREQ_0002              To check notification with URC "+KTCP_SRVREQ" is received in server end shall be correct when there are multiple server sessions and client sessions
#
# Requirement
#   2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCP_SRVREQ_0002
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCP_SRVREQ_0002"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s:To check notification with URC +KTCP_SRVREQ is received in server end shall be correct when there are multiple server sessions and client sessions" % test_ID
    print "***************************************************************************************************************"
    ...
    print '\nStep 4: DUT: TCP Connection Configuration 1\n'
    SagSendAT(uart_com, 'AT+KTCPCFG=,1,,179\r')
    SagWaitnMatchResp(uart_com, ['\r\n+KTCPCFG: 1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    
    print '\nStep 5: DUT: Start TCP Connection 1\n'
    ...
    print '\nStep 7: DUT: TCP Connection Configuration 2\n'
    SagSendAT(uart_com, 'AT+KTCPCFG=,1,,180\r')
    SagWaitnMatchResp(uart_com, ['\r\n+KTCPCFG: 2\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    
    print '\nStep 8: DUT: Start TCP Connection 2\n'
    SagSendAT(uart_com, 'AT+KTCPCNX=2\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 9: AUX: TCP Client 1 Connection Configuration\n'
    SagSendAT(aux1_com, 'AT+KTCPCFG=,0,"%s",179,1111\r' %uart_tcp_ip)
    SagWaitnMatchResp(aux1_com, ['\r\n+KTCPCFG: 1\r\n'], 3000)
    ...
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    print 'DUT: Displaying client connection request notification'
    SagWaitnMatchResp(uart_com, ['\r\n+KTCP_SRVREQ: 1,3,"%s",*\r\n' %aux1_tcp_ip], 2000)
    ...
    SagSendAT(aux1_com, 'AT+KTCPCFG=,0,"%s",179,1112\r' %uart_tcp_ip)
    SagWaitnMatchResp(aux1_com, ['\r\n+KTCPCFG: 2\r\n'], 3000)
    SagWaitnMatchResp(aux1_com, ['OK\r\n'], 3000)
    ...
    SagSendAT(aux1_com, 'AT+KTCPCFG=,0,"%s",180,1113\r' %uart_tcp_ip)
    SagWaitnMatchResp(aux1_com, ['\r\n+KTCPCFG: 3\r\n'], 3000)
    SagWaitnMatchResp(aux1_com, ['OK\r\n'], 3000)
    ...
    SagSendAT(aux1_com, 'AT+KTCPCFG=,0,"%s",180,1114\r' %uart_tcp_ip)
    SagWaitnMatchResp(aux1_com, ['\r\n+KTCPCFG: 4\r\n'], 3000)
    SagWaitnMatchResp(aux1_com, ['OK\r\n'], 3000)
    ...
    print '\nStep 16: AUX: TCP Client 5 Connection Configuration\n'
    SagSendAT(aux1_com, 'AT+KTCPCFG=,0,"%s",180,1115\r' %uart_tcp_ip)
    SagWaitnMatchResp(aux1_com, ['\r\n+KTCPCFG: 5\r\n'], 3000)
    SagWaitnMatchResp(aux1_com, ['OK\r\n'], 3000)
    
    print '\nStep 17: AUX: Start TCP Connection\n'
    SagSendAT(aux1_com, 'AT+KTCPCNX=5\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+KTCP_SRVREQ: 2,7,"%s",*\r\n' %aux1_tcp_ip], 2000)
    
    print '\nStep 18: AUX: Close created session\n'
    ...
    SagSendAT(aux1_com, 'AT+KTCPCLOSE=5,1\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+KTCP_NOTIF: 7,4\r\n'], 2000)
    
    print '\nStep 19: DUT: Close created session\n'
    SagSendAT(uart_com, 'AT+KTCPCLOSE=1,0\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    SagSendAT(uart_com, 'AT+KTCPCLOSE=2,0\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 20: DUT: Delete TCP Connection after closing it\n'
    ...
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    SagSendAT(uart_com, 'AT+KTCPDEL=6\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    SagSendAT(uart_com, 'AT+KTCPDEL=7\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print '\nStep 21: AUX: Delete TCP Connection after closing it\n'
    ...
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
    SagSendAT(aux1_com, 'AT+KTCPDEL=5\r')
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
