...
# A_BX_EmbeddedSW_KTCPCFG_0002                  To check the module shall create server child session to connect with client when the client connection request is accepted
#
# Requirement
#   2 Euler modules
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCPCFG_0002
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCPCFG_0002"
...
try:
    ...
    print '\nStep 7: AUX: TCP Client Connection Configuration\n'
