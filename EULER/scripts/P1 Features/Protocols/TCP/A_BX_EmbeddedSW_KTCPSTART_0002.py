...
# A_BX_EmbeddedSW_KTCPSTART_0002                To check "+KTCPSTART" can start a TCP connection without "+KTCPCNX"
#
# Requirement
#   1 Euler module
#
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KTCPSTART_0002
# -----------------------------------------------------------------------------------
    
test_ID = "A_BX_EmbeddedSW_KTCPSTART_0002"
...
try:
    ...
    print "***************************************************************************************************************"
    print "%s:To check +KTCPSTART can start a TCP connection without +KTCPCNX" % test_ID
    print "***************************************************************************************************************"
    ...
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\n+KTCP_DATA: 1,12,HELLO WORLD\r\r\n'], 2000)
    
    print '\nStep 8: Checking TCP connection\n'
    SagSendAT(uart_com, 'AT+KTCPCFG?\r')
