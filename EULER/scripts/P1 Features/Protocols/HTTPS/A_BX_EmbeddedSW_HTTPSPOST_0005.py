...
# A_BX_EmbeddedSW_HTTPSPOST_0005           Check that +KHTTPSPOST does not work with server that is unsupported <cipher_suite>
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSPOST_0005
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSPOST_0005"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSPOST does not work with server that is unsupported <cipher_suite>' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSPOST does not work with a server by unsupported <cipher_suite>"
    for cipher_suite in all_cipher_suite:
        ...
        print "\nStep 4: Running +KHTTPSPOST with <cipher_suite> %d..." % cipher_suite
        ...
        if not match_result:
            if SagMatchResp(resp, ["\r\nCONNECT\r\n"]):
                ...
                print '\nPROBLEM: +KHTTPS_ERROR: 12 is not received !!!\n'
