...
# A_BX_EmbeddedSW_HTTPSCNX_0006          Check that +KHTTPSCNX works with supported <cipher_suite> EXPORT1024_WITH_DES_CBC_SHA
#
# Requirement
#   1 Euler module
#   1 AP running at 2.4GHz band
#   1 Python HTTPS server supports EXPORT1024_WITH_DES_CBC_SHA
#
# Author: txthuong
#
# Jira ticket:
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSCNX works with supported <cipher_suite> EXPORT1024_WITH_DES_CBC_SHA' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSCNX works with supported <cipher_suite> EXPORT1024_WITH_DES_CBC_SHA\n"
