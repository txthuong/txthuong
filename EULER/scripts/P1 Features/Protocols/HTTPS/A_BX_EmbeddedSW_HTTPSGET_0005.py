...
# A_BX_EmbeddedSW_HTTPSGET_0005            Check that +KHTTPSGET reports HTTP redirection without processing it
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSGET_0005
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSGET_0005"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSGET reports HTTP redirection without processing it' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 4: Perform +KHTTPSGET for a HTTP redirection"
    SagSendAT(uart_com, 'AT+KHTTPSGET=1,"/redirect/6"\r')
    SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 2000)
