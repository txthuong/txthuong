...
# A_BX_EmbeddedSW_HTTPSDELETE_0006              Check that +KHTTPSDELETE properly handles invalid IP address
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSDELETE_0006
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSDELETE_0006"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSDELETE properly handles invalid IP address' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 2: Configure a HTTPS connection by invalid IP address"
    ...
    print "\nStep 4: Perform +KHTTPSDELETE to HTTPS server by invalid IP address"
    ...
    if not SagWaitnMatchResp(uart_com, ['\r\n+KHTTPSCFG: 1,,"%s",443,0,0,1,,,0,0\r\n' % invalid_ip_address], 2000):
        print 'PROBLEM: +KHTTPSDELETE did not handle invalid IP address properly !!!\n'
