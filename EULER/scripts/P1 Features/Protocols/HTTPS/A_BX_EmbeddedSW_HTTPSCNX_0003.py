...
# A_BX_EmbeddedSW_HTTPSCNX_0003          Check that +KHTTPSCNX works with supported <cipher_suite> RC4_128_SHA
#
# Requirement
#   1 Euler module
#   1 AP running at 2.4GHz band
#   1 Python HTTPS server supports RC4_128_SHA
#
# Author: txthuong
#
# Jira ticket:
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSCNX works with supported <cipher_suite> RC4_128_SHA' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSCNX works with supported <cipher_suite> RC4_128_SHA\n"
