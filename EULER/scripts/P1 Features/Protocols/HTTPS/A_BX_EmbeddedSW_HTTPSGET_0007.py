...
# A_BX_EmbeddedSW_HTTPSGET_0007            Check that +KHTTPSGET properly handles invalid IP address
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSGET_0007
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSGET_0007"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSGET properly handles invalid IP address' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 4: Perform +KHTTPSGET to HTTPS server by invalid IP address"
    ...
    if not SagWaitnMatchResp(uart_com, ['\r\n+KHTTPSCFG: 1,,"%s",443,0,0,1,,,0,0\r\n' % invalid_ip_address], 2000):
        print 'PROBLEM: +KHTTPSGET did not handle invalid IP address properly !!!\n'
