...
# A_BX_EmbeddedSW_HTTPSDELETE_0010       Check that +KHTTPSDELETE works with a server by <cipher_suite> AES128-SHA
#
# Requirement
#   1 Euler module
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPSDELETE works with a server by <cipher_suite> AES128-SHA' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nCheck that +KHTTPSDELETE works with supported <cipher_suite> AES128-SHA"
