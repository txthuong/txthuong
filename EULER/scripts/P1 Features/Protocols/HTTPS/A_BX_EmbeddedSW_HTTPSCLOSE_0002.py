...
# A_BX_EmbeddedSW_HTTPSCLOSE_0002               Check that AT+KHTTPSCLOSE command closes a HTTPS connection while keeping +KHTTPSCFG setting
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPSCLOSE_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPSCLOSE_0002"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that AT+KHTTPSCLOSE command closes a HTTPS connection while keeping +KHTTPSCFG setting' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 4: Perform +HTTPSGET to connect to HTTPS server"
    SagSendAT(uart_com, 'AT+KHTTPSGET=1,"/get"\r')
    SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 5000)
    SagWaitnMatchResp(uart_com, ['HTTP/1.1 200 OK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['*{*"Host": "%s"*}' % https_server], 2000)
    SagWaitnMatchResp(uart_com, ['*\r\nOK\r\n'], 2000)
