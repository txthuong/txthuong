...
# A_BX_EmbeddedSW_HTTPGET_0007             Check that +KHTTPGET can send data to HTTP server
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPGET_0007
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPGET_0007"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPGET can send data to HTTP server' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 4: Perform +KHTTPGET to send data variables"
    SagSendAT(uart_com, 'AT+KHTTPGET=1,"/get?Param=euler_test"\r')
    SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['HTTP/1.1 200 OK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['*"Param": "euler_test"'], 2000)
    SagWaitnMatchResp(uart_com, ['*\r\nOK\r\n'], 2000)
