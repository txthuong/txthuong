...
# A_BX_EmbeddedSW_HTTPGET_0011         Check that +KHTTPGET reports HTTP status codes
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPGET_0011
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPGET_0011"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPGET reports HTTP status codes' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 4: Perform +KHTTPGET for a HTTP status code 404"
    SagSendAT(uart_com, 'AT+KHTTPGET=1,"/not-exist-path/"\r')
    SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['HTTP/1.1 404 NOT FOUND\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['*The requested URL was not found on the server'], 2000)
    SagWaitnMatchResp(uart_com, ['*\r\nOK\r\n'], 2000)
