...
# A_BX_EmbeddedSW_HTTPCNX_0002           To try start HTTP connection 10 times with the command "+KHTTPCNX", check the connection time
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPCNX_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPCNX_0002"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: To try start HTTP connection 10 times with the command "+KHTTPCNX", check the connection time' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 3: Try start HTTP connection 10 times"
    for i in range (0,10):
    ...
    print "\nStep 4: Delete the HTTP connection"
