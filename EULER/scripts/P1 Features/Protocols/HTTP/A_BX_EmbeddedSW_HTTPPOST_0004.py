...
# A_BX_EmbeddedSW_HTTPPOST_0004            Check that +KHTTPPOST properly handles invalid domain name
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPPOST_0004
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPPOST_0004"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPPOST properly handles invalid domain name' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 2: Configure a HTTP connection with invalid domain name"
    ...
    if not match_result:
        if SagMatchResp(resp, ["*\r\nOK\r\n", "*\r\nERROR\r\n", "*\r\n+CME ERROR: *\r\n"]):
            print "\nPROBLEM: +KHTTPPOST does not handle invalid domain properly.\n"
        else:
    ...
    print "\nStep 5: Delete HTTP configuration"
    SagSendAT(uart_com, 'AT+KHTTPDEL=1\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)

    print "\nStep 6: Query HTTP configuration"
    SagSendAT(uart_com, 'AT+KHTTPCFG?\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
