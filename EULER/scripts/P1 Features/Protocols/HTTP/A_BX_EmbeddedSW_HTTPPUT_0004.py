...
# A_BX_EmbeddedSW_HTTPPUT_0004             Check that +KHTTPPUT properly handles invalid domain name
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPPUT_0004
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPPUT_0004"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPPUT properly handles invalid domain name' % test_ID
    print "***************************************************************************************************************"
    ...
    invalid_donmain = 'www.example.invalid'
    print "\nStep 2: Configure a HTTP connection with an invalid domain name"
    SagSendAT(uart_com, 'AT+KHTTPCFG=,%s\r' % invalid_donmain)
    SagWaitnMatchResp(uart_com, ['\r\n+KHTTPCFG: 1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
