...
# A_BX_EmbeddedSW_HTTPDEL_0002      To check HTTP session must be closed (using +KHTTPCLOSE) before using the command "+KHTTPDEL" to close it
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPDEL_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPDEL_0002"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: To check HTTP session must be closed (using +KHTTPCLOSE) before using the command "+KHTTPDEL" to close it' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 6: Check +KHTTPDEL with connected session"
    ...
    print "\nStep 8: Check +KHTTPDEL closed session"
    SagSendAT(uart_com, 'AT+KHTTPDEL=1\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
