...
# A_BX_EmbeddedSW_HTTPHEAD_0005                 Check that +KHTTPHEAD supports basic authentication
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPHEAD_0005
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPHEAD_0005"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPHEAD supports basic authentication' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 4: Perform +KHTTPHEAD with basic authentication"
    SagSendAT(uart_com, 'AT+KHTTPHEAD=1,"/basic-auth/%s/%s"\r' % (http_user, http_password))
    SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 2000)
