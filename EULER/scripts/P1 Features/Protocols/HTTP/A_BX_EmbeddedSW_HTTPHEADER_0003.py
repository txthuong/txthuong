...
# A_BX_EmbeddedSW_HTTPHEADER_0003          Check that +KHTTPHEADER can add fields to HTTP Request Header
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPHEADER_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPHEADER_0003"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPHEADER can add fields to HTTP Request Header' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 6: Run +KHTTPGET to check HTTP header fields"
    SagSendAT(uart_com, 'AT+KHTTPGET=1,"/headers"\r')
    SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['HTTP/1.1 200 OK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['*"headers":*{*"From":*"euler@example.net",*"Host":*"%s"*}' % http_server], 2000)
    SagWaitnMatchResp(uart_com, ['*\r\nOK\r\n'], 2000)
