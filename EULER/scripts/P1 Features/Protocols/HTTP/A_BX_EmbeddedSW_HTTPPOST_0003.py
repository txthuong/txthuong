...
# A_BX_EmbeddedSW_HTTPPOST_0003            Check that +KHTTPPOST properly handles invalid IP address
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPPOST_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPPOST_0003"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPPOST properly handles invalid IP address' % test_ID
    print "***************************************************************************************************************"
    ...
    SagSendAT(uart_com, 'AT+KHTTPCFG=,%s\r' % invalid_id_addr)
    SagWaitnMatchResp(uart_com, ['\r\n+KHTTPCFG: 1\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    ...
    if not match_result:
        if SagMatchResp(resp, ["*\r\nOK\r\n", "*\r\nERROR\r\n", "*\r\n+CME ERROR: *\r\n"]):
            print "\nPROBLEM: +KHTTPPOST does not handle invalid IP address properly.\n"
        else:
