...
# A_BX_EmbeddedSW_HTTPGET_0008             Check that +KHTTPGET reports HTTP redirection without processing it
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPGET_0008
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPGET_0008"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPGET reports HTTP redirection without processing it' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 4: Perform +KHTTPGET for a HTTP redirection"
    SagSendAT(uart_com, 'AT+KHTTPGET=1,"/redirect/6"\r')
    SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['HTTP/1.1 302 FOUND\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['*You should be redirected automatically to target URL'], 2000)
    SagWaitnMatchResp(uart_com, ['*\r\nOK\r\n'], 2000)
