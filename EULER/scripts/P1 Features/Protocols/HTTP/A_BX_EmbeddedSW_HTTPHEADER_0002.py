...
# A_BX_EmbeddedSW_HTTPHEADER_0002          Check that +KHTTPHEADER does not add any HTTP header field by default
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_HTTPHEADER_0002
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_HTTPHEADER_0002"
...
try:
    ...
    print "***************************************************************************************************************"
    print '%s: Check that +KHTTPHEADER does not add any HTTP header field by default' % test_ID
    print "***************************************************************************************************************"
    ...
    print "\nStep 5: Run +KHTTPGET to check HTTP header fields"
    SagSendAT(uart_com, 'AT+KHTTPGET=1,"/headers"\r')
    SagWaitnMatchResp(uart_com, ['\r\nCONNECT\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['HTTP/1.1 200 OK\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['*"headers":*{*"Host":*"%s"*}' % http_server], 2000)
    SagWaitnMatchResp(uart_com, ['*\r\nOK\r\n'], 2000)
