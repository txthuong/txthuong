...
# A_BX_EmbeddedSW_KMQTTSUB_0003     Check that +KMQTTSUB can subscribe a topic from specific MQTT session
#
# Requirement
#   1 Euler module
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_KMQTTSUB_0003
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_KMQTTSUB_0003"
...
try:
    ...
    for version in (3, 4):
        ...
        print "\nStep 7: Close the MQTT connection"
