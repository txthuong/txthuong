...
try:
    ...
    SagSendAT(uart_com, 'AT+SRWAPCFG="%s","12345678x@X",4,5,0,100\r' %wifi_ssid)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print "\nStep 5: Execute command to query current AP configurations\n"
    SagSendAT(uart_com, 'AT+SRWAPCFG?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRWAPCFG: "%s","12345678x@X",4,5,0,100\r\n' %wifi_ssid],2000)
    SagWaitnMatchResp(uart_com, ['OK\r\n'], 2000)
    ...
    SagSendAT(aux1_com, 'AT+SRWSTACFG="%s","12345678x@X",1\r' %wifi_ssid)
    SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
...
#Disconnect
SagSendAT(aux1_com, 'AT+SRWSTACFG="%s","12345678x@X",0\r' %wifi_ssid)
SagWaitnMatchResp(aux1_com, ['\r\nOK\r\n'], 2000)
