...
try:
    ...
    SagSendAT(uart_com, 'AT+SRWAPNETCFG=1,"192.168.0.1","192.168.0.2","192.168.0.2",1\r' )
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    
    print "\nStep 7: Execute command to query current DHCP setting\n"
    SagSendAT(uart_com, 'AT+SRWAPNETCFG?\r')
    SagWaitnMatchResp(uart_com, ['\r\n+SRWAPNETCFG: 1,"192.168.0.1","192.168.0.2","192.168.0.2",1\r\n'],2000)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    ...
    SagSendAT(uart_com, 'AT+SRWAPNETCFG=1,"10.0.0.1","10.0.0.2","10.0.0.2",1\r')
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    time.sleep(75)
