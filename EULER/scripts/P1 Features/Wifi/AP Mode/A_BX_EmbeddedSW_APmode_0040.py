...
# A_BX_EmbeddedSW_APmode_0040                   Check that device supports DHCP sever when it's in Wifi AP mode
#
# Requirement
# 1 Euler module
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_APmode_0040
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_APmode_0040"
...
try:
    ...
    print "\nStep 7: Use AUX1 module to connect to this Access Point\n"
