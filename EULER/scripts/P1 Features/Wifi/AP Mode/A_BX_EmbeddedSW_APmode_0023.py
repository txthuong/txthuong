...
# A_BX_EmbeddedSW_APmode_0023                   Use command +SRWAPNETCFG to configure DHCP assign Class A IP addresses
#
# Requirement
# 2 Euler module
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_APmode_0023
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_APmode_0023"
...
try:
    ...
    SagWaitnMatchResp(uart_com, ['\r\n+SRWAPNETCFG: 1,"10.0.0.1","10.0.0.2","10.0.0.2",720\r\n'], 2000)
    SagWaitnMatchResp(uart_com, ['\r\nOK\r\n'], 2000)
    ...
    SagWaitnMatchResp(aux1_com, ['\r\n+SRWSTAIP: "10.0.0.2","255.255.255.0","10.0.0.1"\r\n'], 2000)
