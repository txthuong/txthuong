...
# A_BX_EmbeddedSW_APmode_0031                   Use command +SRWAPNETCFG to configure the end assigned IP address with Class C and use number 255 as host IP address
#
# Requirement
# 1 Euler module
#  
