...
# A_BX_EmbeddedSW_STAMode_0017                  Verify output of command +SRWSTASCN: <ssid> should be displayed correctly
#
# Requirement
# 2 Euler modules
#  
...
# -----------------------------------------------------------------------------------
# A_BX_EmbeddedSW_STAMode_0017 
# -----------------------------------------------------------------------------------

test_ID = "A_BX_EmbeddedSW_STAMode_0017"
...
try:
    ...
    print "*****************************************************************************************************************"
    print "%s: Verify output of command +SRWSTASCN: <ssid> should be displayed correctly" % test_ID
    print "*****************************************************************************************************************"
    ...
    if '"%s"' % dut_mac_address not in response:
        print "\nFailed !!! DUT Access Point in hidden SSID\n"
