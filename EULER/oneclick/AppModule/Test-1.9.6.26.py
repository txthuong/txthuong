...
##                                                                                        if 'UART1_COM' in line:
##                                                                                                UART1_COM = line.split('=')[1].strip()
##                                                                                                break
##                                                                                        if 'UART2_COM' in line:
##                                                                                                UART2_COM = line.split('=')[1].strip()
##                                                                                                break
##                                                                                        if 'UART3_COM' in line:
##                                                                                                UART3_COM = line.split('=')[1].strip()
##                                                                                                break
##                                                                                        if 'USB_COM' in line:
##                                                                                                USB_COM = line.split('=')[1].strip()
##                                                                                                break
##                                                                                        if 'DLC1_COM' in line:
##                                                                                                DLC1_COM = line.split('=')[1].strip()
##                                                                                                break
##                                                                        for each_com in [UART1_COM,UART2_COM,UART3_COM,USB_COM,DLC1_COM]:
##                                                                                if each_com == 0:
##                                                                                        continue
##                                                                                resp = MySendAT(each_com,"AT+CCID\r")
##                                                                                p = re.compile("CCID:\s+(\d+)")
##                                                                                k = p.search(resp)
##                                                                                if k is not None:
##                                                                                        ccid = k.group(1)
##                                                                        
