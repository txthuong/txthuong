...
class AVMS3:   
    ...
    def __init__(self,imei,companyuid="2a06bfb7765d49d3ac023cd2bbc42b1d", username="vhoang@tma.com.vn",password="Ho@ng0pensource",clientId="d693c9089d574f1898c2f7d691763913",secretKey="28cfeeb447d94ec3a1a253941112d187"):
        self.imei = imei        
        ...
        # 2017-08-01, nqtoan, modify for ILM company
        #self.__companyuid = "d7378fc019c649bf8131afe3d3eb3663"
        self.__companyuid = companyuid
    ...
    def __getVeryImportParameter(self):
        ...
        request = self.__serverUrl + '/api/v1/systems?company=' + self.__companyuid + '&fields=uid&access_token=' + self.token + '&gateway=serialNumber:' + self.imei
        print request
        try:
...
#####################################################################################################        
def createSystem(systemName = '', uidFw = '', uidGateway = '',companyuid="2a06bfb7765d49d3ac023cd2bbc42b1d", username="vhoang@tma.com.vn",password="Ho@ng0pensource",clientId="d693c9089d574f1898c2f7d691763913",secretKey="28cfeeb447d94ec3a1a253941112d187"):
...
#######################################################################################################
def activateSystem(uidSystem,companyuid="2a06bfb7765d49d3ac023cd2bbc42b1d", username="vhoang@tma.com.vn",password="Ho@ng0pensource",clientId="d693c9089d574f1898c2f7d691763913",secretKey="28cfeeb447d94ec3a1a253941112d187"):
...
def creatReport(name = "SZ-Validation-Temp",
                ...
                congig_list = [""],companyuid="2a06bfb7765d49d3ac023cd2bbc42b1d", username="vhoang@tma.com.vn",password="Ho@ng0pensource",clientId="d693c9089d574f1898c2f7d691763913",secretKey="28cfeeb447d94ec3a1a253941112d187"):
    serverUrl = "https://eu.airvantage.net"
    ...
    return report_id
######################################################################################################################
def deleteReport(uid,companyuid="2a06bfb7765d49d3ac023cd2bbc42b1d", username="vhoang@tma.com.vn",password="Ho@ng0pensource",clientId="d693c9089d574f1898c2f7d691763913",secretKey="28cfeeb447d94ec3a1a253941112d187"):
    serverUrl = "https://eu.airvantage.net"
    ...
    return r
########################################################################################################################################################
def findAllReport(companyuid="2a06bfb7765d49d3ac023cd2bbc42b1d", username="vhoang@tma.com.vn",password="Ho@ng0pensource",clientId="d693c9089d574f1898c2f7d691763913",secretKey="28cfeeb447d94ec3a1a253941112d187"):
    serverUrl = "https://eu.airvantage.net"
...
if __name__ == u'__main__':
    #mySystem = AVMS3(u"356776070002220")
    mySystem = AVMS3(u"353347080000928")
    import time
    ...
    # mySystem = AVMS3(u"352768050019914")
